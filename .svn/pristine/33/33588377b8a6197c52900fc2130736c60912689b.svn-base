...
{
    public class clsEliminarEstadoFinancieroFlujoEfectivo : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsEliminarEstadoFinancieroFlujoEfectivo(byte bt_IdEstadoFinanciero, string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\EliminarEstadoFinancieroFlujoEfectivo.config", this);
        }
        #endregion
