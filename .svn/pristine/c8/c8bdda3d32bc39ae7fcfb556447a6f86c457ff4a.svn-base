...
{
    public class clsConsultarArchivosAnexosEstadosFinancierosCargados : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsConsultarArchivosAnexosEstadosFinancierosCargados(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\ConsultarArchivosAnexosEstadosFinancierosCargados.config", this);
        }
        #endregion
