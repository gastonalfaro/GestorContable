...
{
    public partial class frmReporteTitulosReclasLPCP : BASE
    {
        # region Variables
      ...
      //private static DataTable ldat_Cancelaciones = new DataTable();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        if (!clsSeguridadVistas.MostrarElementos(gstr_Usuario, Master, "frmReporteTitulosReclasLPCP"))
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                lstr_NroValor = this.ddlNumValor.SelectedValue.Equals("0") ? "-1" : this.ddlNumValor.SelectedValue;
                ...
                if (!strUsuario.Equals(string.Empty))// && (!str_Institucion.Equals(string.Empty)))
                {
                    ...
                    oParametros.Add(new ReportParameter("pFchValorDesde", lstr_FechaInicio, false));
                    oParametros.Add(new ReportParameter("pFchValorHasta", lstr_FechaFin, false));

                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteTitulosReclasificados"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
        ...
        protected void ddlNemotecnico_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                ddlNumValor.DataSource = dt_Titulos;
