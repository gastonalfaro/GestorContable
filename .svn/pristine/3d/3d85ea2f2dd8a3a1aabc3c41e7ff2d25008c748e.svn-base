...
{
    public class clsRegistrarUsuario : clsProcedimientoAlmacenado
    {
        /// <summary>
        /// Cedula del Usuario
        /// </summary>
        ...
        public clsRegistrarUsuario(string str_Cedula, string str_TipoID, string str_Nombre, 
            string str_Contrasena, string str_Correo)
        {
            ...
            EjecucionSP(str_DireccionConfigs + "\\Seguridad\\RegistrarUsuario.config", this);
        }
    }
}