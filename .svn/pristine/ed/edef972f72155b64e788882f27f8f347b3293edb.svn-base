...
{
    public class clsBuscarArchivoPlantillaEstadoFinanciero : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsBuscarArchivoPlantillaEstadoFinanciero(string str_IdEstadoFinancieroArchivoPlantilla, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\BuscarArchivoPlantillaEstadoFinanciero.config", this);
        }
        #endregion
