...
{
    public partial class CargaEntidad : BASE
    {
...
/**/
        ...
        public DataSet GetDataSetGridView_ConsultarEstadosFinancierosCargados()
        {
            ...
            try
            {
                ...
                {
                    DesplegarError(true);
                    lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorParametros"].ToString());
                    dsNICSPDatosGridView = GetDataSetGridView_ConsultarEstadosFinancierosCargados_Vacio();
                }
...
/**/
        ...
        protected void EstadosFinancierosArchivosGridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                {
                    lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorBorrarArchivo"].ToString());
                }
                else
                {
        ...
        protected Boolean Eliminar_ArchivoEstadoFinanciero(string strIdEstadoFinancieroArchivo)
        {
            ...
            try
            {
                ...
                //{
                //    //Error
                //    lsbError.Items.Add( dsNICSPDatos.Tables["Result"].Rows[0]["message"].ToString();
                //    boolError = true;
                //}
                //else
                //{
            ...
            try
            {
                ...
                if (e.CommandName == "Select")
                {
                    ...
                    if ((!strIdEstadoFinancieroArchivosAnexos.Equals(string.Empty)))
                    {
                        ...
                        {
                            DesplegarError(true);
                            lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorRetornoNulo"].ToString());
                        }
...
/**/
        ...
        public Boolean DesplegarError(Boolean boolError)
        {
            ...
            {
                if (boolError)
                    lsbError.Visible = true;
                else
                    lsbError.Visible = false;
        ...
        protected void CargarArchivosButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string VarDTSX, Resultado, Mensaje, DTSX_PaqueteURL, DTSX_RutaDescargaArchivo, DTSX_DescargaArchivoEnServer, DTSX_CargaEstadoFinancieroFlujoEfectivo, DTSX_CargaEstadoFinancieroCambioPatrimonioNeto, DTSX_CargaEstadoFinancieroBalanceComprobacion, DTSX_Ruta32Bit;
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    //if (!dsNICSPDatosDropDownList.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                    {
                        ...
                        if(bCargaUnidadTiempoPeriodoValido)
                        {
                                ...
                                if (strIdEntidad.Equals(strExcelIdEntidad) && strPeriodo.Equals(strExcelPeriodo) && strUnidadTiempoPeriodo.Equals(strExcelUnidadTiempoPeriodo))
                                {
                                    if (validaSize(bufferFlujoEfectivo.Length, strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo))
                                    {
                                        ...
                                        if (DesplegarError(!bCargaArchivo))
                                        {
                                            ...
                                            DesplegarError(true);
                                            lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorCargaArchivo"].ToString() + strNombreArchivo);
                                        }
                                        else
                                        {                                            
                                            ...
                                            WSINICSP_PC.uwsEjecutarDTSX(DTSX_PaqueteURL, DTSX_DescargaArchivoEnServer, VarDTSX, Run64BitRuntime_DTSX_DescargaArchivoEnServer, DTSX_Ruta32Bit, "", gstr_Usuario, out Resultado, out Mensaje);
                                            ...
                                            if (DesplegarError(!Resultado.Equals("00")))
                                            {
                                                ...
                                                DesplegarError(true);
                                                lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorCargaArchivo"].ToString() + " (Bajar en Carpeta) " + strNombreArchivo);
                                            }
                                            else
                                            {
                                                ...
                                                WSINICSP_PC.uwsEjecutarDTSX(DTSX_PaqueteURL, DTSX_CargaEstadoFinancieroFlujoEfectivo, VarDTSX, Run64BitRuntime_DTSX_CargaEstadoFinancieroFlujoEfectivo, DTSX_Ruta32Bit, "", gstr_Usuario, out Resultado, out Mensaje);
                                                ...
                                                if (DesplegarError(!Resultado.Equals("00")))
                                                {
                                                    ...
                                                    DesplegarError(true);
                                                    lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorCargaArchivo"].ToString() + " (Bajar en Tabla) " + strNombreArchivo);
                                                }
                                                else
                                                {
                                                    ...
                                                    if (DesplegarError(!Resultado.Equals("00")))
                                                    {
                                                        ...
                                                        DesplegarError(true);
                                                        lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorValidaPeriodoActual"].ToString() + " (Bajar en Tabla) " + strNombreArchivo);
                                                    }
                                                    else
                                                    {
                                                        //if (dsNICSPDatos.Tables.Count > 0)//Si hizo la consulta pero No retorno nada
                                                        if (!dsNICSPDatos.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                                                        {
                                                            ...
                                                            lsbError.Items.Add("Validación de los Datos del Flujo de Efectivo...");
                                                            lsbError.Items.Add("Consecutivo, ErrorDescripcion, IdEntidad, Periodo, UnidadTiempoPeriodo, NumConsecutivo, NumCuenta, CuentaConcepto, MontoPeriodoActual, MontoPeriodoAnterior");
                                                            for (int i = 0; i <= dsNICSPDatos.Tables["Table"].Rows.Count - 1; i++)
                                                            {
                                    ...
                                    {
                                        DesplegarError(true);
                                        lsbError.Items.Add(ConfigurationManager.AppSettings["ErrorSizeByteMaxTotalArchivos"].ToString().Replace("X", ((Double.Parse(ConfigurationManager.AppSettings["SizeByteMaxTotalArchivos"].ToString()) / 1024.00) / 1024.00).ToString()));
                                    }
                                }
                                else
                                {
                                    DesplegarError(true);
                                    lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorDatosWebContraExcel"].ToString());
                                }
                            }
                            else
                            {
                                ...
                                {
                                    DesplegarError(true);
                                    lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorNoExisteArchivoFlujoEfectivo"].ToString());
                                }
                            }
                                    ...
                                    if (validaSize(bufferCambioPatrimonioNeto.Length, strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo))
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                WSINICSP_PC.uwsEjecutarDTSX(DTSX_PaqueteURL, DTSX_CargaEstadoFinancieroCambioPatrimonioNeto, VarDTSX, Run64BitRuntime_DTSX_CargaEstadoFinancieroCambioPatrimonioNeto, DTSX_Ruta32Bit, "", gstr_Usuario, out Resultado, out Mensaje);
                                                ///*dsNICSPDatos*/ string asd = WSINICSP_PC.uwsPrueba2("", ""/*,out Resultado, out Mensaje*/);
                                                //dsNICSPDatos = WSINICSP_PC.ValidarEstadoFinancieroFlujoEfectivo(strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo, "", gstr_Usuario, out Resultado, out Mensaje);
                                                ...
                                                else
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        if (!dsNICSPDatos.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                                                        {
                                                            ...
                                                            lsbError.Items.Add("Validación de los Datos del Cambio Patrimonio Neto...");
                                                            lsbError.Items.Add("Consecutivo, ErrorDescripcion, IdEntidad, Periodo, UnidadTiempoPeriodo, NumConsecutivo, Concepto, Capital, TransferenciasCapital, ReservasRevaluacionBienes, ReservasOtrasreservas, VariacionesNoAsignablesReservas, ResultadosAcumulados, Totales, InteresesMinoritarios, TotalPatrimonio ");
                                                            for (int i = 0; i <= dsNICSPDatos.Tables["Table"].Rows.Count - 1; i++)
                                                            {
                                                                Consecutivo = dsNICSPDatos.Tables["Table"].Rows[i]["Consecutivo"].ToString();
                                                                ErrorDescripcion = dsNICSPDatos.Tables["Table"].Rows[i]["ErrorDescripcion"].ToString();
                            ...
                            else
                            {
                                ...
                                {
                                    DesplegarError(true);
                                    lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorNoExisteArchivoCambioPatrimonioNeto"].ToString());
                                }
                            }
                                    ...
                                    if (validaSize(bufferBalanceComprobacion.Length, strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo))
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                WSINICSP_PC.uwsEjecutarDTSX(DTSX_PaqueteURL, DTSX_CargaEstadoFinancieroBalanceComprobacion, VarDTSX, Run64BitRuntime_DTSX_CargaEstadoFinancieroBalanceComprobacion, DTSX_Ruta32Bit, "", gstr_Usuario, out Resultado, out Mensaje);
                                                ///*dsNICSPDatos*/ string asd = WSINICSP_PC.uwsPrueba2("", ""/*,out Resultado, out Mensaje*/);
                                                //dsNICSPDatos = WSINICSP_PC.ValidarEstadoFinancieroFlujoEfectivo(strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo, "", gstr_Usuario, out Resultado, out Mensaje);
                                                ...
                                                else
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        if (!dsNICSPDatos.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                                                        {
                                                            ...
                                                            lsbError.Items.Add("Validación de los Datos del Balance de Comprobación...");
                                                            lsbError.Items.Add("Consecutivo, ErrorDescripcion, IdEntidad, Periodo, UnidadTiempoPeriodo, NumConsecutivo, NumCuenta, CuentaConcepto, MontoPeriodoActual, MontoPeriodoAnterior");
                                                            for (int i = 0; i <= dsNICSPDatos.Tables["Table"].Rows.Count - 1; i++)
                                                            { 
                                                                Consecutivo = dsNICSPDatos.Tables["Table"].Rows[i]["Consecutivo"].ToString();
                                                                ...
                                                                lsbError.Items.Add(Consecutivo + ", " + ErrorDescripcion + ", " + IdEntidad + ", " + Periodo + ", " + UnidadTiempoPeriodo + ", " + NumConsecutivo + ", " + NumCuenta + ", " + NumCuentaDepurada + ", " + SociedadGL + ", " + CuentaConcepto + ", " + SaldoInicial + ", " + DebitosPeriodo + ", " + CreditosPeriodo + ", " + SaldoFinal);
                                                                DesplegarError(true);
                                                            }
                            ...
                            else
                            {
                                ...
                                {
                                    DesplegarError(true);
                                    lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorNoExisteArchivoBalanceComprobacion"].ToString());
                                }
                            }
                            ...
                            else
                            {
                                ...
                                {
                                    DesplegarError(true);
                                    lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorNoExisteArchivoEstadoVarios"].ToString());
                                }
                            }
                            ...
                            else
                            {
                                ...
                                {
                                    DesplegarError(true);
                                    lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorNoExisteArchivoNotasEstadosFinancieros"].ToString());
                                }
                            }
                        ...
                        {
                            lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorValidaPeriodoActual2"].ToString());
                            lsbError.Items.Add( Descripcion);
                            DesplegarError(true);
                        }
                    }
                    else
                    {
                        DesplegarError(true);
                        lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorValidaPeriodoActual"].ToString());
                    }
        ...
        protected void ArchivosPlantillasButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        DesplegarError(true);
                        lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorNoExisteArchivoPlantillasEstadosFinancieros"].ToString());
                    }
                }
...
/**/
        ...
        protected void CorreosAutorizacionButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        DesplegarError(true);
                        lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorNoExisteArchivoAnexosEstadosFinancieros"].ToString());
                    }
                }
        ...
        protected void RevisionInstitucionButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))                    
                {
                    ...
                    {
                        lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorCambioEstado"].ToString() + ". Etapa:" + CodigoCatalogoEtapasEstadoFinancieroUsuarioInstitucion);
                    }
                    else
                    {
                        ...
                        if (DesplegarError(!bCambioEstado))
                        {
                            lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorCambioEstado"].ToString() + ". Etapa:" + CodigoCatalogoEtapasEstadoFinancieroEnTramiteRevisionInstitucion);
                        }
                        else
                        {
                            RevisionInstitucionButton.Enabled = false;
        ...
        protected void RechazadoInstitucionButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    if (DesplegarError(!bCambioEstado))
                    {
                        lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorCambioEstado"].ToString() + ". Etapa:" + CodigoCatalogoEtapasEstadoFinancieroRechazadoInstitucion);
                    }
                    else
                    {
                        bCambioEstado = WSINICSP_PC.InsertarEtapaEstadoFinanciero(strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo, int.Parse(CodigoCatalogoEtapasEstadoFinancieroUsuarioInstitucion),
        ...
        protected void AprobarInstitucionButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    if (DesplegarError(!bCambioEstado))
                    {
                        lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorCambioEstado"].ToString() + ". Etapa:" + CodigoCatalogoEtapasEstadoFinancieroAprobadoInstitucion);
                    }
                    else
                    {
                        ...
                        if (DesplegarError(!bCambioEstado))
                        {
                            lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorCambioEstado"].ToString() + ". Etapa:" + CodigoCatalogoEtapasEstadoFinancieroEnTramiteRevisionAnalista);
                        }
                        else
                        {
        ...
        protected void RechazadoAnalistaButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    if (DesplegarError(!bCambioEstado))
                    {
                        lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorCambioEstado"].ToString() + ". Etapa:" + CodigoCatalogoEtapasEstadoFinancieroRechazadoAnalista);
                    }
                    else
                    {
                        bCambioEstado = WSINICSP_PC.InsertarEtapaEstadoFinanciero(strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo, int.Parse(CodigoCatalogoEtapasEstadoFinancieroUsuarioInstitucion),
        ...
        protected void AprobarAnalistaButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    if (DesplegarError(!bCambioEstado))
                    {
                        lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorCambioEstado"].ToString() + ". Etapa:" + CodigoCatalogoEtapasEstadoFinancieroAprobadoAnalista);
                    }
                    else
                    {
        ...
        public void ValidarVisibilidadEstadosEtapas()
        {
            DataSet dsNICSPDatos = new DataSet();
            wsPlantillasConsolidacion WSINICSP_PC = new wsPlantillasConsolidacion();
            try
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    if (Resultado.Equals("00"))
                    {
                        if (dsNICSPDatos.Tables.Count > 0)//Si hizo la consulta pero No retorno nada                    
                        {
                            if (!dsNICSPDatos.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                            {
                                DataRow lastRow = dsNICSPDatos.Tables["Table1"].Rows[dsNICSPDatos.Tables["Table1"].Rows.Count - 1];
                                IdEtapaEstadoFinanciero = lastRow["IdEtapaEstadoFinanciero"].ToString();

                                if (IdEtapaEstadoFinanciero.Equals("1"))//UsuarioInstitucion
                                {
                                    RevisionInstitucionButton.Visible = true;
                                    RechazadoInstitucionButton.Visible = false;
                                    AprobarInstitucionButton.Visible = false;
                                    RechazadoAnalistaButton.Visible = false;
                                    AprobarAnalistaButton.Visible = false;
                                }
                                else
                                {
                                    if (IdEtapaEstadoFinanciero.Equals("2"))//EnTramiteRevisionInstitucion
                                    {
                                        RevisionInstitucionButton.Visible = false;
                                        RechazadoInstitucionButton.Visible = true;
                                        AprobarInstitucionButton.Visible = true;
                                        RechazadoAnalistaButton.Visible = false;
                                        AprobarAnalistaButton.Visible = false;
                                    }
                                    else
                                    {
                                        if (IdEtapaEstadoFinanciero.Equals("3"))//AprobadoInstitucion
                                        {
                                            //Nada
                                        }
                                        else
                                        {
                                            if (IdEtapaEstadoFinanciero.Equals("4"))//RechazadoInstitucion
                                            {
                                                //Nada
                                            }
                                            else
                                            {
                                                if (IdEtapaEstadoFinanciero.Equals("5"))//EnTramiteRevisionAnalista
                                                {
                                                    ...
                                                    RechazadoInstitucionButton.Visible = false;
                                                    AprobarInstitucionButton.Visible = false;
                                                    RechazadoAnalistaButton.Visible = true;
                                                    AprobarAnalistaButton.Visible = true;
                                                }
                                                else
                                                {
                                                    if (IdEtapaEstadoFinanciero.Equals("6"))//AprobadoAnalista
                                                    {
                                                        //Nada
                                                    }
                                                    else
                                                    {
                                                        if (IdEtapaEstadoFinanciero.Equals("7"))//RechazadoAnalista
                                                        {
                                                            //Nada
                                                        }
                                                    }
                    ...
                    {
                        DesplegarError(true);
                        lsbError.Items.Add(ConfigurationManager.AppSettings["strErrorConsultaEtapaEstadoFinanciero"].ToString());
                    }
                }
                else
                {
