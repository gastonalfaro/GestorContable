...
{
    public partial class frmAmortizaciones : BASE
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        if (!clsSeguridadVistas.MostrarElementos(gstr_Usuario, Master, "frmAmortizacionesDE"))
                        {
        ...
        private void ConsultarFormularios(string str_IdPrestamo, string str_IdTramo, string dt_FechValorAcreedor, string dt_FechTipoCambio, string dt_FechRecepcion)
        {

            gds_Formularios = wsDE.ConsultarAmortizacion(str_IdPrestamo , str_IdTramo, dt_FechValorAcreedor, dt_FechTipoCambio, dt_FechRecepcion,"","");
        ...
        private DataTable LlenarTablaVacia()
        {
            ...
            ldt_TablaVacia.Columns.Add("FchRecepcion", typeof(string));
            ...
            ldt_TablaVacia.Columns.Add("Modal", typeof(string));
            ldt_TablaVacia.Columns.Add("EstadoSigade", typeof(string));  //typeof(string));
            ldt_TablaVacia.Columns.Add("Estado", typeof(string));  //typeof(string));
        ...
        {
            OcultarMensaje();
            ConsultarFormularios(txtBusqIdPrestamo.Text, txtBusqIdTramo.Text, txtFechaValorAcreedor.Text, txtFechaTipoCambio.Text, txtBusqFechaRecepcion.Text);
        }
        ...
        protected void grdvFormularios_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            grdvFormularios.DataBind();
            //this.ConsultarFormularios(txtBusqIdPrestamo.Text, txtBusqIdTramo.Text, txtFechaValorAcreedor.Text, txtFechaTipoCambio.Text, txtBusqFechaRecepcion.Text);
        }
