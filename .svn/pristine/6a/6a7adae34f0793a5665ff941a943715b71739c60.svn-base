...
{
    public class clsConsultarPagoFormulario : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsConsultarPagoFormulario(int? lint_IdFormulario,
                                                 int? lint_Anno,
                                                 int? lint_IdPago,
            ...
            )
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CapturaIngresos\\ConsultarPagosFormulario.config", this);
            }
            catch (Exception ex)
            {
