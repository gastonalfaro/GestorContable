...
{
    public class clsRPTEntidadesEntregaEstadoFinancieroATiempo : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsRPTEntidadesEntregaEstadoFinancieroATiempo(DateTime dt_FechaInicio, DateTime dt_FechaFin, string str_IdEntidad, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\RPTEntidadesEntregaEstadoFinancieroATiempo.config", this);
        }
        #endregion
