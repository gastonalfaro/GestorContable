...
{
    public class clsBuscarArchivoAnexoEstadoFinanciero : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsBuscarArchivoAnexoEstadoFinanciero(string str_IdEstadoFinancieroArchivo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\BuscarArchivoAnexoEstadoFinanciero.config", this);
        }
        #endregion
