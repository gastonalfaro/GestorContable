...
{
    public partial class EstadoFinancieroCambioPatrimonioNetoDesagregado : BASE
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    CambioPatrimonioNetoDesagregadoMultiView.ActiveViewIndex = 0;
                }
            }
            catch (Exception ex)
            {
        ...
        protected void ViewCambioPatrimonioNetoDesagregadoLinkButton_Click(object sender, EventArgs e)
        {
            CambioPatrimonioNetoDesagregadoMultiView.ActiveViewIndex = 0;
        ...
        {
            CambioPatrimonioNetoDesagregadoMultiView.ActiveViewIndex = 1;
        }
        ...
        protected void VerReporteButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (/*(!strUsuario.Equals(string.Empty)) &&*/ /*(!strIdEntidad.Equals(string.Empty))*/ (!strPeriodo.Equals(string.Empty)) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteEstadoFinancieroCambioPatrimonioNetoDesagregado"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
                    ...
                    CambioPatrimonioNetoDesagregadoMultiView.ActiveViewIndex = 1;
                    this.ViewCambioPatrimonioNetoDesagregadoLinkButton.Visible = true;
                    this.ViewReporteLinkButton.Visible = true;
                    this.SeparadorCambioPatrimonioNetoDesagregadoReporteLabel.Visible = true;
                }
                else
                {
