            ...
            if (m_Slots.length > in_SlotIndex) {
                ...
                try {
                    ...
                    if (privatekeys.length >= 1) {
                        ...
                        iaik.pkcs.pkcs11.Mechanism signatureMechanism =new iaik.pkcs.pkcs11.Mechanism(PKCS11Constants.CKM_RSA_PKCS);//iaik.pkcs.pkcs11.Mechanism(PKCS11Constants.CKM_RSA_PKCS);
