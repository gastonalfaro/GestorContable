...
{
    public partial class EstadoFinancieroCambioPatrimonioNetoDesagregadoPorAmbitoConsolidacionNumCuenta : BASE
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    CambioPatrimonioNetoDesagregadoPorAmbitoConsolidacionNumCuentaMultiView.ActiveViewIndex = 0;
                }
            }
            catch (Exception ex)
            {
        ...
        protected void ViewCambioPatrimonioNetoDesagregadoPorAmbitoConsolidacionNumCuentaLinkButton_Click(object sender, EventArgs e)
        {
            CambioPatrimonioNetoDesagregadoPorAmbitoConsolidacionNumCuentaMultiView.ActiveViewIndex = 0;
        ...
        {
            CambioPatrimonioNetoDesagregadoPorAmbitoConsolidacionNumCuentaMultiView.ActiveViewIndex = 1;
        }
        ...
        protected void VerReporteButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (/*(!strIdEntidad.Equals(string.Empty)) &&*/ (!strPeriodo.Equals(string.Empty)) && (!strUnidadTiempoPeriodo.Equals(string.Empty)) && (!strNumCuenta.Equals(string.Empty)))
                {
                    ...
                    CambioPatrimonioNetoDesagregadoPorAmbitoConsolidacionNumCuentaMultiView.ActiveViewIndex = 1;
                    this.ViewCambioPatrimonioNetoDesagregadoPorAmbitoConsolidacionNumCuentaLinkButton.Visible = true;
                    this.ViewReporteLinkButton.Visible = true;
                    this.SeparadorCambioPatrimonioNetoDesagregadoPorAmbitoConsolidacionNumCuentaReporteLabel.Visible = true;
                }
                else
                {
