...
{
    public class clsConsultaSaldosDeudaExt : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsConsultaSaldosDeudaExt(string lstr_IdPrestamo, int? lint_IdTramo, DateTime? ldt_FechaDesde, DateTime? ldt_FechaHasta)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\ConsultarSaldosDeudaExt.config", this);
            }
            catch (Exception ex)
            {
