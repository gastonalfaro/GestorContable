...
{
    public class clsEliminarArchivoEstadoFinanciero: clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsEliminarArchivoEstadoFinanciero(string str_IdEstadoFinancieroArchivo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\EliminarArchivoEstadoFinanciero.config", this);
        }
        #endregion
