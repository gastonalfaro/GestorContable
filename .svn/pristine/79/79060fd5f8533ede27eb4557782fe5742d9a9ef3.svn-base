...
{
    public class clsConsultarCalculosDevengoMensualDE : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsConsultarCalculosDevengoMensualDE(string lstr_IdPrestamo, int? lint_IdTramo, DateTime? ldt_FechaDesde = null, DateTime? ldt_FechaHasta = null)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\ConsultarCalculosDevengoMensualDE.config", this);
            }
            catch (Exception ex)
            {
