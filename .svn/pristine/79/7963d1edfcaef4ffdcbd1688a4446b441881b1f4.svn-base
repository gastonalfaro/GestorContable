...
{
    public class clsValidaEstadoFinancieroBalanceComprobacion : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsValidaEstadoFinancieroBalanceComprobacion(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\ValidaEstadoFinancieroBalanceComprobacion.config", this);
        }
        #endregion
