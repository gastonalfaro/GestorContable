...
{
    public class clsModificaComision : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsModificaComision(string lstr_IdPrestamo, string lint_IdTramo, int? lint_IdComision, string lstr_TipoComision,
            ...
            string lstr_Periodo, string lstr_Anno, string lstr_Mes, string lstr_TipoPago, string lstr_EstadoComision, string lstr_UsrModifica, DateTime? ldt_FchModifica)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\ModificarComision.config", this);
            }
            catch (Exception ex)
            {
