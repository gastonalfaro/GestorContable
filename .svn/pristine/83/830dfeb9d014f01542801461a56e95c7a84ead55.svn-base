...
{
    public partial class frmReporteAuxiliarContable : BASE
    {
        # region Variables
       ...
       // private static DataTable ldat_Cancelaciones = new DataTable();
        ...
        {
            DataSet lNemotecnicos = ws_SGService.uwsConsultarNemotecnicos("", "", "", "UDE", "");
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!strUsuario.Equals(string.Empty))// && (!str_Institucion.Equals(string.Empty)))
                {
                    ...
                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteAuxiliar"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
        ...
        protected void ddlNemotecnico_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //this.ddlNumValor.DataSource = wsDeudaInterna.ConsultarTitulosValores("%", this.ddlNemotecnico.SelectedValue.Trim(), "%", "%", "%", "01/01/1900", "01/01/5000");
