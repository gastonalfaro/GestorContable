...
{
    public class clsBorrarServicioOficina : clsProcedimientoAlmacenado
    {
        ...
        public clsBorrarServicioOficina(string str_IdServicio, string str_IdSociedadGL,string str_IdOficina)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "\\Mantenimiento\\BorrarServicioOficina.config", this);
            }
            catch (Exception ex)
            {
