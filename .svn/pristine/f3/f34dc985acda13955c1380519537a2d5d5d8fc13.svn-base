...
public class PKCS11LibraryFileAndPINCodeDialog extends JDialog {
    ...
    public PKCS11LibraryFileAndPINCodeDialog() {
        ...
        this.setSize(new Dimension(326, 150));
        this.setBackground(SystemColor.control);
        this.setTitle("PIN de smart card.");
        ...
        mChooseLibraryFileLabel.setText(
        	"PKCS#11 archivo de impementacion de tarjeta  (aspkcs.dll(windows)");
        ...
        mLibraryFileNameTextField.setBounds(new Rectangle(10, 25, 315, 24));
        ...
        mBrowseForLibraryFileButton.setVisible(false);
        ...
        mEnterPINCodeLabel.setText("Código o PIN");
        mEnterPINCodeLabel.setBounds(new Rectangle(10, 5, 400, 15));
        mEnterPINCodeLabel.setFont(new Font("Dialog", 0, 12));

        // Initialize PIN code text field
        mPINCodeTextField.setBounds(new Rectangle(15, 25, 80, 20));
        mPINCodeTextField.setFont(new Font("DialogInput", 0, 12));

        // Initialize sign button
        mSignButton.setText("Aceptar");
        mSignButton.setBounds(new Rectangle(100, 90, 75, 25));
        ...
        mCancelButton.setText("Cancelar");
        mCancelButton.setBounds(new Rectangle(200, 90, 80, 25));
    ...
    private static class LibraryFileFilter extends FileFilter {
        ...
        public String getDescription() {
            return "PKCS#11 v2.0 o version mas reciente de la libreria de implementacion (.dll, .so)";
        }
    }
