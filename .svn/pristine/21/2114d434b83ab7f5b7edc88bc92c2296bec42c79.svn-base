...
{
    public class clsEliminarEtapaEstadoFinanciero : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsEliminarEtapaEstadoFinanciero(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, DateTime dt_FechaDeEtapaEstado, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\EliminarEtapaEstadoFinanciero.config", this);
        }
        #endregion
