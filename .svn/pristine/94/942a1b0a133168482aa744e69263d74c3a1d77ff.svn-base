...
{
    public class clsCambiaEstadoTramo : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsCambiaEstadoTramo(string lstr_IdPrestamo, int lint_IdTramo, string lstr_Estado, string lstr_UsrModifica, DateTime ldt_FchModifica)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\EstadoTramo.config", this);
            }
            catch (Exception ex)
            {
