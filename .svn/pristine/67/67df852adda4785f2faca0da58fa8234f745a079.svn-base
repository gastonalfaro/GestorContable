...
{
    public class clsBuscarCatalogoEtapaEstadoFinanciero : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsBuscarCatalogoEtapaEstadoFinanciero(int int_IdEtapaEstadoFinanciero, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\BuscarCatalogoEtapaEstadoFinanciero.config", this);
        }
        #endregion
