...
{
    public class clsCambiaEstadoGiro : clsProcedimientoAlmacenado
    {
        #region Parámetros

        private string lstr_IdPrestamo;
        private int lint_IdTramo;
        private string ldt_FchDesembolso;
        ...
        public string Ldt_FchDesembolso
        {
        ...
        public clsCambiaEstadoGiro(string lstr_IdPrestamo, int lint_IdTramo, string ldt_FchDesembolso,string ldt_FchEstimada, string lstr_Moneda, int lint_Secuencia, string lstr_Estado, string lstr_UsrModifica, DateTime ldt_FchModifica)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\EstadoGiro.config", this);
            }
            catch (Exception ex)
            {
