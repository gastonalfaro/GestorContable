...
{
    public class clsEjecutarDTSX : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsEjecutarDTSX(string str_DTSXPaqueteURL, string str_DTSXPaqueteNombre, string str_DTSXPaqueteVariable, bool b_bEjecutar64Bit, string str_Ruta32Bit, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\EjecutarDTSX.config", this);
        }
        #endregion
