...
{
    public class clsConsultaDevengoInteresCanje : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        #region Constructor
        public clsConsultaDevengoInteresCanje()
        {

        }

        public clsConsultaDevengoInteresCanje(string lint_NumValor, string lstr_Nemotecnico)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaInterna\\ConsultarDevengoInteresesCanje.config", this);
            }
            catch (Exception ex)
            {
