...
{
    public class clsConsultarOficinasCeBe : clsProcedimientoAlmacenado
    {
        ...
        public clsConsultarOficinasCeBe(string str_IdOficina, string str_IdSociedadGL, string str_IdModulo, string str_IdCentroBeneficio)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "\\Mantenimiento\\ConsultarOficinasCeBe.config", this);
            }
            catch (Exception ex)
            {
