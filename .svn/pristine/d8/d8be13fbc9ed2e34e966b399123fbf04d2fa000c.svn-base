<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/PortalPrincipal.Master" AutoEventWireup="true" CodeBehind="frmReporteSubastaEmision.aspx.cs" Inherits="Presentacion.CalculosFinancieros.DeudaInterna.frmReporteSubastaEmision" EnableEventValidation="false" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="Contenido" runat="server">
    <div id="datos">
         <div style="display:inline-block;align-items:center; width:100%;">
            <h3>Reporte de Subasta por Emisión:</h3>
