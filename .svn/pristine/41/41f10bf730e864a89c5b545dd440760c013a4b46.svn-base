...
public class Applet_Firma_Digital_Autorizaciones extends Applet {
    ...
    public void set_XML_STR_SIGNED(String XML_FILE_STR_SIGNED, String CEDULA) {
        try {
            ...
            window.setMember("XML_AUTORIZACION_SIGNED", XML_FILE_STR_SIGNED);
            window.setMember("CEDULA_PERSONA_QUE_AUTORIZA", CEDULA);
    ...
    public String get_AUTORIZACION_XML_STR() {
        try {
            return (String) JSObject.getWindow(this).eval("get_info_autorizacion()");
        } catch (JSException e) {
            mtr_msg("ALERTA !!! " + e.getMessage());
            return null;
        }
            ...
            public Object run() {
                ...
                if (lst_c != null) {
                    ...
                    if (alias != null) {
                        ...
                        String xml_signed = dgs.sign_xml_AUTORIZACION(c_sign, cedula_con_formato(c_sign) + ";" + get_AUTORIZACION_XML_STR());
                        if (xml_signed != null) {
                            set_XML_STR_SIGNED(xml_con_formato(xml_signed), cedula_con_formato(c_sign));
                        } else {
                            mtr_msg("Se cancelo la operación !!!");
                        }
                    } else {
                        mtr_msg("Se cancelo la operación !!!");
                    }
