...
{
    public class clsCrearOficinaCeBe : clsProcedimientoAlmacenado
    {
        ...
        public clsCrearOficinaCeBe(string str_IdOficina, string str_IdSociedadGL, string str_IdModulo, string str_IdCentroBeneficio, string str_UsrCreacion)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "\\Mantenimiento\\CrearOficinaCeBe.config", this);
            }
            catch (Exception ex)
            {
