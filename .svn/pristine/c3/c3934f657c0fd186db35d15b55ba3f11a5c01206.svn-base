<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/PortalPrincipal.Master" AutoEventWireup="true" CodeBehind="frmReporteSaldoDeudaExt.aspx.cs" Inherits="Presentacion.CalculosFinancieros.DeudaExterna.Reportes.frmReporteSaldoDeudaExt" EnableEventValidation="false" %>
       ...
       <div id="datos">
        ...
        <div class="col-md-12 divStyle" >
             <div class="col-md-6 divStyle">
                ...
                <div class="col-md-6">
                    <asp:DropDownList ID="ddlNroPrestamo" runat="server" AppendDataBoundItems="True" AutoPostBack="True"  CssClass="FormatoDropDownList" OnSelectedIndexChanged="ddlNroPrestamo_SelectedIndexChanged" >
                        </asp:DropDownList>
                ...
                <div class="col-md-6">
                                    <asp:DropDownList ID="ddENumeroTramo" runat="server" CssClass="FormatoDropDownList">
