...
{
    public class clsRPTEntidadesEntregaEstadoFinancieroRechazadas : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsRPTEntidadesEntregaEstadoFinancieroRechazadas(DateTime dt_FechaInicio, DateTime dt_FechaFin, string str_IdEntidad, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\RPTEntidadesEntregaEstadoFinancieroRechazadas.config", this);
        }
        #endregion
