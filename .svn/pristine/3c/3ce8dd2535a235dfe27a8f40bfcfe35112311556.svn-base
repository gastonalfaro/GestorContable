...
{
    public partial class frmNuevoAcreedor : BASE
    {
        # region Variables
        ...
        protected void btnVolverAcreedores_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Mantenimiento/frmAcreedores.aspx", false);
        }

        protected void btnCrearAcreedor_Click(object sender, EventArgs e)
        {
            String[] str_result = new String[3];
            
            str_result = ws_SGService.uwsCrearAcreedor(Convert.ToInt32(txtNumAcreedor.Text), txtDescripcion.Text, this.txtAbreviatura.Text,
                txtContacto.Text, txttelefono.Text, txtDireccion.Text, txtPais.Text, this.txtTipo.Text, this.txtPaisInstitucion.Text, 
                this.chkEstado.Checked ? "A" : "I", gstr_Usuario);
