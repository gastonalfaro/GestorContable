...
{
    public class clsCreaInteresPunitivo : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsCreaInteresPunitivo(string lstr_IdPrestamo, int? lint_IdTramo, DateTime? ldt_FchPagoAPartir, DateTime? ldt_FchTasaAPartir, string lstr_Tasa,
            ...
            string lstr_Estado, string lstr_UsrCreacion)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\CrearInteresPunitivo.config", this);
            }
            catch (Exception ex)
            {
