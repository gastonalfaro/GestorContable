...
namespace Presentacion.wsAsientosSG {
    using System;
    ...
    public partial class ServicioContable : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public ServicioContable() {
            this.Url = global::Presentacion.Properties.Settings.Default.Presentacion_wsAsientosSG_ServicioContable;
        ...
        public string[] EnviarAsientos(ZfiAsiento[] tabla_asientos) {
        ...
        /// <remarks/>
        public void EnviarAsientosAsync(ZfiAsiento[] tabla_asientos) {
            this.EnviarAsientosAsync(tabla_asientos, null);
        }
        
        /// <remarks/>
        public void EnviarAsientosAsync(ZfiAsiento[] tabla_asientos, object userState) {
            ...
            this.InvokeAsync("EnviarAsientos", new object[] {
                        tabla_asientos}, this.EnviarAsientosOperationCompleted, userState);
        }
