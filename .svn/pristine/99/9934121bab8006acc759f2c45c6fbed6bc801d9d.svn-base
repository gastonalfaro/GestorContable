...
{
    public partial class frmReporteSaldosDI : BASE
    {
        # region Variables
       ...
       //private static DataTable ldat_Cancelaciones = new DataTable();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        if (!clsSeguridadVistas.MostrarElementos(gstr_Usuario, Master, "frmReporteSaldosDI"))
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string lstr_Nemotecnico, lstr_Moneda, lstr_Tipo;
                ...
                if (!strUsuario.Equals(string.Empty))// && (!str_Institucion.Equals(string.Empty)))
                {
                    ...
                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteSaldosDI"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
