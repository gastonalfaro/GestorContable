...
{
    public partial class EstadoFinancieroFlujoEfectivoDesagregado : BASE
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    FlujoEfectivoDesagregadoMultiView.ActiveViewIndex = 0;
                }
            }
            catch (Exception ex)
            {
        ...
        protected void ViewFlujoEfectivoDesagregadoLinkButton_Click(object sender, EventArgs e)
        {
            FlujoEfectivoDesagregadoMultiView.ActiveViewIndex = 0;
        ...
        {
            FlujoEfectivoDesagregadoMultiView.ActiveViewIndex = 1;
        }
        ...
        protected void VerReporteButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (/*(!strUsuario.Equals(string.Empty)) &&*/ /*(!strIdEntidad.Equals(string.Empty))*/ (!strPeriodo.Equals(string.Empty)) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteEstadoFinancieroFlujoEfectivoDesagregado"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
                    ...
                    FlujoEfectivoDesagregadoMultiView.ActiveViewIndex = 1;
                    this.ViewFlujoEfectivoDesagregadoLinkButton.Visible = true;
                    this.ViewReporteLinkButton.Visible = true;
                    this.SeparadorFlujoEfectivoDesagregadoReporteLabel.Visible = true;
                }
                else
                {
