...
public class AppletTesting extends Applet {
    public void init() {
        this.applicar_estilo_look_and_feel_windows();
    }//FUNCION
            ...
            public Object run() {
                ...
                if (lst_c != null) {
                    ...
                    if (alias != null) {
                        ...
                        String xml_signed = dgs.sign_file_xml(c_sign, get_FORMULARIO_XML_STR());
                        if (xml_signed != null) {
    ...
    public void set_XML_STR_SIGNED(String XML_FILE_STR_SIGNED, String CEDULA) {
        try {
            ...
            window.setMember("XML_STR_FILE_SIGNED", XML_FILE_STR_SIGNED);
            window.setMember("NUM_CEDULA", CEDULA);
    ...
    public String get_FORMULARIO_XML_STR() {
        try {
            return (String) JSObject.getWindow(this).eval("get_xml_str()");
        } catch (JSException e) {
            mtr_msg("ALERTA !!! " + e.getMessage());
            return null;
        }
