...
{
    public class clsCrearCalculosDevengoMensualDE : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsCrearCalculosDevengoMensualDE(string lstr_IdPrestamo,
        int? lint_IdTramo,
        DateTime? ldt_Fecha,
        ...
        string lstr_UsrCreacion)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\CrearCalculosDevengoMensualDE.config", this);
            }
            catch (Exception ex)
            {
