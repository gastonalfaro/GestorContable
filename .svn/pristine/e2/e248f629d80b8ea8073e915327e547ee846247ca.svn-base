...
{
    public partial class frmNuevoIndicadorEconomico : BASE
    {
        # region Variables
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(gstr_Usuario))
                {
                    ...
                    if (!clsSeguridadVistas.MostrarElementos(gstr_Usuario, Master, "frmIndicadoresEconomicos"))
                    {
        ...
        {
            Response.Redirect("~/Mantenimiento/frmIndicadoresEconomicos.aspx", false);
        }
        ...
        protected void btnCrearCatalogo_Click(object sender, EventArgs e)
        {
            ...
            str_result = ws_SGService.uwsCrearIndicadorEconomico(txtIdIndicadorEco.Text, txtTransaccion.Text, txtNomIndicador.Text,lstr_Estado, gstr_Usuario );
            ...
            if ((str_result[0].ToString().Equals("00")) || str_result[0].ToString().Equals("True"))
            {
                ...
                this.txtIdIndicadorEco.Text = "";
                this.txtNomIndicador.Text = "";
