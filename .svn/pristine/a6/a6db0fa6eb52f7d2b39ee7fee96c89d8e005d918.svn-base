...
{
    public class clsValidaEstadoFinancieroCambioPatrimonioNeto : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsValidaEstadoFinancieroCambioPatrimonioNeto(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\ValidaEstadoFinancieroCambioPatrimonioNeto.config", this);
        }
        #endregion
