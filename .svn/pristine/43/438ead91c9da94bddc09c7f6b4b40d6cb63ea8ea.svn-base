<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/PortalPrincipal.Master" AutoEventWireup="true" CodeBehind="Consulta.aspx.cs" Inherits="Presentacion.RevelacionNotas.Consulta" %>
    ...
    <div id="formularioRN">
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="lblJustificacionConsulta" runat="server" Height="62px" ReadOnly="True" TextMode="MultiLine" CssClass="FormatoTextBox"></asp:TextBox>
                </td>
            </tr>
<%--            <tr>
                <td>
            ...
            <asp:Panel ID="pnlModificacion" runat="server" Visible="false">
                <tr>
                    ...
                    <td>
                        ...
                        <%--<ew:CalendarPopup ID="calFechaLimiteEdicion" runat="server" Style="margin-right: 0px"></ew:CalendarPopup>--%>
...
<%--    OnClientClick="javascript:CallPrint('formularioRN');"--%>
    <asp:HiddenField ID="hdnFecha" runat="server" OnValueChanged="hdnFecha_ValueChanged" />
    </asp:Content>
