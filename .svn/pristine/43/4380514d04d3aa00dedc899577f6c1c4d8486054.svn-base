...
{
    public partial class frmReporteCuponesPagados : BASE
    {
        # region Variables
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        if (!clsSeguridadVistas.MostrarElementos(gstr_Usuario, Master, "frmReporteCuponesPagados"))
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string lstr_Nemotecnico, lstr_NroValor, lstr_NroCupon, lstr_ModuloSINPE;
                ...
                lstr_Nemotecnico = ddlNemotecnico.SelectedValue == "" ? null : ddlNemotecnico.SelectedValue;
                lstr_NroValor = ddlNumValor.SelectedValue == "" ? null : ddlNumValor.SelectedValue;
                lstr_NroCupon = ddlNroCupon.SelectedValue == "" ? null : ddlNroCupon.SelectedValue;
                lstr_ModuloSINPE = null;

                ldt_FechaInicio = Convert.ToDateTime(this.txtFchInicio.Text);
                ldt_FechaFin = Convert.ToDateTime(this.txtFchFin.Text);
                ...
                if (!strUsuario.Equals(string.Empty))// && (!str_Institucion.Equals(string.Empty)))
                {
                    ...
                    oParametros.Add(new ReportParameter("pNroCupon", lstr_NroCupon, false));
                    oParametros.Add(new ReportParameter("pModulo", lstr_ModuloSINPE, false));
                    ...
                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteCuponesPagados"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
        ...
        protected void ddlNemotecnico_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataTable dt_ConsultaTitulos = new DataTable();
            dt_ConsultaTitulos = wsDeudaInterna.ConsultarTitulosValores(string.Empty, this.ddlNemotecnico.SelectedValue.Trim(), String.Empty, String.Empty, String.Empty, String.Empty, String.Empty, String.Empty, "01/01/1900", "01/01/5000").Tables[0];
            this.ddlNumValor.DataTextField =
            this.ddlNumValor.DataValueField = "NroValor";
            if (dt_ConsultaTitulos.Rows.Count > 0) 
            {
                this.ddlNumValor.DataSource = dt_ConsultaTitulos;
        ...
        protected void ddlNumValor_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            this.ddlNroCupon.Items.Clear();
            DataSet ds_Dinamico = ws_SGService.uwsConsultarDinamico("SELECT [NroCupon] FROM [cf].[TitulosValores] where [NroValor] = " + this.ddlNumValor.SelectedValue.Trim());
            this.ddlNroCupon.DataTextField =
            this.ddlNroCupon.DataValueField = "NroCupon";
            if (ds_Dinamico.Tables.Count > 0 &&  ds_Dinamico.Tables[0].Rows.Count > 0)
            {
                this.ddlNroCupon.DataSource =ds_Dinamico;
                this.ddlNroCupon.DataBind();
            }//if

            ddlNroCupon.Items.Insert(0, (new ListItem("-- Seleccione Opción --", "")));
        }
