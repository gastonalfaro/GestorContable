...
{
    public class clsModificaTituloGarantia : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsModificaTituloGarantia(int lint_NumValor, string lstr_Nemotecnico, string lstr_EstadoValor, string lstr_IndicadorGarantia,
            string lstr_UsrModifica, DateTime ldt_FchModifica)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaInterna\\ModificarTituloGarantia.config", this);
            }
            catch (Exception ex)
            {
