...
{
    public partial class frmReporteNemotecnicosCPLP : BASE
    {
        # region Variables
      ...
      //private static DataTable ldat_Cancelaciones = new DataTable();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        if (!clsSeguridadVistas.MostrarElementos(gstr_Usuario, Master, "frmReporteNemotecnicosCPLP"))
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string lstr_Nemotecnico, lstr_Moneda, lstr_Plazo, lstr_NroValor, lstr_Tipo, lstr_PrimaDescuento;
                ...
                lstr_NroValor = string.IsNullOrEmpty(ddlNumValor.SelectedValue) ? "-1" : ddlNumValor.SelectedValue;
                lstr_Tipo = ddlTipoValor.SelectedValue;
                lstr_PrimaDescuento = ddlPrimaDescuento.SelectedValue;
                ...
                if (!strUsuario.Equals(string.Empty))// && (!str_Institucion.Equals(string.Empty)))
                {
                    ...
                    oParametros.Add(new ReportParameter("pPlazo", lstr_Plazo, false));
                    ...
                    oParametros.Add(new ReportParameter("pPrimaDescuento", lstr_PrimaDescuento, false));
                    ...
                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteNemotecnicosCPLP"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
        ...
        protected void ddlNemotecnico_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            dt_Titulos =  wsDeudaInterna.ConsultarTitulosValores(string.Empty, this.ddlNemotecnico.SelectedValue.Trim(), String.Empty, String.Empty, "V", String.Empty, String.Empty, String.Empty, "01/01/1900", "01/01/5000").Tables[0];
