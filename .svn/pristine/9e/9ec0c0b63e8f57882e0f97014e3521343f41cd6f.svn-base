...
{
    public class clsCreaPrestamo: clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsCreaPrestamo(string lstr_IdPrestamo, string lstr_Fuente, string lstr_Situacion, string lstr_Plazo, 
            ...
            DateTime ldt_CondicionFchFin, string lstr_Estado, string lstr_UsrCreacion)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\CrearPrestamo.config", this);
            }
            catch (Exception ex)
            {
