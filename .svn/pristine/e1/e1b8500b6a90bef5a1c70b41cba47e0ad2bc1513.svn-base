...
{
    public class clsModificarCatalogoEtapaEstadoFinanciero : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsModificarCatalogoEtapaEstadoFinanciero(int int_IdEtapaEstadoFinanciero, string str_DescripEtapaEstadoFinanciero, string str_Usuario, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\ModificarCatalogoEtapaEstadoFinanciero.config", this);
        }
        #endregion
