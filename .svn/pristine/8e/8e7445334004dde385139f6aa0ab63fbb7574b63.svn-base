...
{
    public class clsBorrarBancoServicio : clsProcedimientoAlmacenado
    {
        ...
        public clsBorrarBancoServicio(string str_IdBanco, string str_IdServicio, string str_IdSociedadGL)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "\\Mantenimiento\\BorrarBancoServicio.config", this);
            }
            catch (Exception ex)
            {
