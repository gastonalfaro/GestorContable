...
{
    public class clsEliminarEstadoFinancieroBalanceComprobacion : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsEliminarEstadoFinancieroBalanceComprobacion(byte bt_IdEstadoFinanciero, string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\EliminarEstadoFinancieroBalanceComprobacion.config", this);
        }
        #endregion
