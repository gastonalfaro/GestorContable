...
{
    public class clsEliminarCalculosFlujoEfectivoDE : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsEliminarCalculosFlujoEfectivoDE(string lstr_IdPrestamo, int? lint_IdTramo, DateTime? ldt_Fecha = null, DateTime? ldt_FechaHasta = null, string lstr_UsrCreacion  = null)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\EliminarCalculosFlujoEfectivoDE.config", this);
            }
            catch (Exception ex)
            {
