...
{
    public class clsEliminarEstadoFinanciero : clsProcedimientoAlmacenado
    {
        #region variables 
        ...
        public clsEliminarEstadoFinanciero(byte bt_IdEstadoFinanciero, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\EliminarEstadoFinanciero.config", this);
        }
        #endregion
