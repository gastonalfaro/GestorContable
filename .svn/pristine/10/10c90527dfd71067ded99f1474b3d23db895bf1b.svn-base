...
{
    public partial class frmReporteCancelacion : BASE
    {
        # region Variables
      ...
      //private static DataTable ldat_Cancelaciones = new DataTable();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        if (!clsSeguridadVistas.MostrarElementos(gstr_Usuario, Master, "frmReporteCancelacion"))
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string lstr_Nemotecnico, lstr_NroValor, lstr_Tipo, lstr_TipoNegociacion,lstr_Moneda,lstr_Cuenta;
                ...
                if (!strUsuario.Equals(string.Empty))// && (!str_Institucion.Equals(string.Empty)))
                {
                    ...
                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteCancelaciones"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
        ...
        protected void ddlNemotecnico_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataTable dt_TitulosValores = new DataTable();
            dt_TitulosValores  = wsDeudaInterna.ConsultarTitulosValores(string.Empty, this.ddlNemotecnico.SelectedValue.Trim(), String.Empty, String.Empty, String.Empty, String.Empty, String.Empty, String.Empty, "01/01/1900", "01/01/5000").Tables[0];
            this.ddlNumValor.DataTextField = "NroValor";
            this.ddlNumValor.DataValueField = "NroValor";

            if (dt_TitulosValores.Rows.Count > 0) 
            {
                this.ddlNumValor.DataSource = dt_TitulosValores;
