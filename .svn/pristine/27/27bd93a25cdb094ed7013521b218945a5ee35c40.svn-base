...
{
    public partial class EstadoFinancieroDeudaPublicaAgregado : BASE
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    DeudaPublicaAgregadoMultiView.ActiveViewIndex = 0;
                }
            }
            catch (Exception ex)
            {
        ...
        protected void ViewDeudaPublicaAgregadoLinkButton_Click(object sender, EventArgs e)
        {
            DeudaPublicaAgregadoMultiView.ActiveViewIndex = 0;
        ...
        {
            DeudaPublicaAgregadoMultiView.ActiveViewIndex = 1;
        }
        ...
        protected void VerReporteButton_Click(object sender, EventArgs e)
        {
            try
            {
                string strUsuario, strIdEntidad, strAmbitoConsolidacion, strPeriodo, strUnidadTiempoPeriodo;
                ...
                if (/*(!strIdEntidad.Equals(string.Empty)) &&*/ (!strPeriodo.Equals(string.Empty)) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                  ...
                  //  oParametros.Add(new ReportParameter("AmbitoConsolidacion", strAmbitoConsolidacion, false));
                    ...
                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteEstadoFinancieroDeudaPublicaAgregado"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
                    ...
                    DeudaPublicaAgregadoMultiView.ActiveViewIndex = 1;
                    this.ViewDeudaPublicaAgregadoLinkButton.Visible = true;
                    this.ViewReporteLinkButton.Visible = true;
                    this.SeparadorDeudaPublicaAgregadoReporteLabel.Visible = true;
                }
                else
                {
