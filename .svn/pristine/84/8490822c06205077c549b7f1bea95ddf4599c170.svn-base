...
{
    public class clsModificarPago : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsModificarPago(string lstr_IdPrestamo, int? lint_IdTramo, int? lint_IdPago, string lstr_IdMoneda, int? lint_IdAcreedor, string lstr_RefAcreedor,
            ...
            DateTime? ldt_FechaTipoCambio, string lstr_UsrModifica, DateTime ldt_FchModifica)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\ModificarPago.config", this);
            }
            catch (Exception ex)
            {
