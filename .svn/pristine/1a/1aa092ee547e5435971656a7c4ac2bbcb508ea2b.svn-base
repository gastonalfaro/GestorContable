...
{
    public class clsModificarAcreedor : clsProcedimientoAlmacenado
    {
        ...
        public clsModificarAcreedor(Int32 int_NroAcreedor, string str_NomAcreedor, string str_Abreviatura, string str_Contacto, string str_Telefono, string str_Direccion, string str_Pais, string str_TipoAcreedor, string str_PaisInstitucion, string str_IdCtaContable, string str_UsrModifica, DateTime dt_FchModifica)
        {
            ...
            lstr_IdCtaContable = str_IdCtaContable;
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "\\Mantenimiento\\ModificarAcreedor.config", this);
            }
            catch (Exception ex)
            {
