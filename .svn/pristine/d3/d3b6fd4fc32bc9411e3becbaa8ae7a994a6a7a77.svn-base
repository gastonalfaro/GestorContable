...
{
    public class clsCambiaEstadoComision : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsCambiaEstadoComision(string lstr_IdPrestamo, int? lint_IdTramo, int? lint_IdComision, string lstr_Estado, string lstr_UsrModifica, DateTime ldt_FchModifica)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\EstadoComision.config", this);
            }
            catch (Exception ex)
            {
