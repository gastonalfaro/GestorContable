<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/PortalPrincipal.Master" AutoEventWireup="true" CodeBehind="EstadoFinancieroDeudaPublicaDesagregado.aspx.cs" Inherits="Presentacion.Consolidacion.Reportes.EstadoFinancieroDeudaPublicaDesagregado" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <tr>
        <td>
            <asp:LinkButton ID="ViewDeudaPublicaDesagregadoLinkButton" runat="server" 
                    onclick="ViewDeudaPublicaDesagregadoLinkButton_Click" Visible="false">Parametros</asp:LinkButton>
        </td>
        <td>
            <asp:Label ID="SeparadorDeudaPublicaDesagregadoReporteLabel" runat="server" Text="|" Visible="false"></asp:Label>
        </td>
        <td>
    ...
    <br />
    <asp:Label ID="Label1" runat="server" Text="Reporte de Deuda Pública Desagregado."></asp:Label>

    <asp:Panel id="DeudaPublicaDesagregadoPanel" HorizontalAlign="Left" runat="Server">  
        <asp:MultiView id="DeudaPublicaDesagregadoMultiView" ActiveViewIndex="0" runat="Server">
            <asp:View id="DeudaPublicaDesagregadoView" runat="Server">                                                                               
