...
{
    public class clsRPTEstadoFinancieroCambioPatrimonioNetoDesagregado : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsRPTEstadoFinancieroCambioPatrimonioNetoDesagregado(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\RPTEstadoFinancieroCambioPatrimonioNetoDesagregado.config", this);
        }
        #endregion
