...
{
    public class clsCambiaEstadoTasaFlotante : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsCambiaEstadoTasaFlotante(string lstr_IdPrestamo, int lint_IdTramo, DateTime ldt_APartir, string lstr_Estado, string lstr_UsrModifica, DateTime ldt_FchModifica)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\EstadoTasaFlotante.config", this);
            }
            catch (Exception ex)
            {
