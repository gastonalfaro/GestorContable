...
namespace LogicaNegocio.Mantenimiento
{
    ...
    {
        public DataSet RecibeBalanceComprobacion(wsSAPBC.ZINT_EST_CAB_BALANCE_CONSOL t_cabecera, wsSAPBC.ZINT_EST_POS_BALANCE_CONSOL[] t_posicion)
        {
            ...
            try
            {
                ...
                //wsSAPBC.ZINT_RECIBE_BALANCE_COMPROBA ServicioRBC = new wsSAPBC.ZINT_RECIBE_BALANCE_COMPROBA(); cucurucho
                //wsSAPBC.ZINT_RECIBE_BALANCE_COMPROBA1 MetodoRBC = new wsSAPBC.ZINT_RECIBE_BALANCE_COMPROBA1(); cucurucho
                ...
                {
                    Posicion = new wsSAPBC.ZINT_EST_POS_BALANCE_CONSOL();
                ...
                string lstr_user = System.Configuration.ConfigurationManager.AppSettings["USER_SAP"];//WebServiceBalanceComprobacion.Properties.Settings.Default.USER_SAP;
                //System.Configuration.ConfigurationManager.AppSettings["USER_SAP"];
                string lstr_pass = System.Configuration.ConfigurationManager.AppSettings["PASS_SAP"];//WebServiceBalanceComprobacion.Properties.Settings.Default.PASS_SAP;
                ...
                //RespuestaRBC = ServicioRBC.ZINT_RECIBE_BALANCE_COMPROBA(MetodoRBC);
