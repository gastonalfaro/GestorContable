...
/// </summary>
public sealed class clsNumALetras
{
    ...
    public const Boolean ConvertirDecimalesDefault = true;//ggarcia false
    ...
    public clsNumALetras(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
    {
    ...
    {
        return clsNumALetras.ToCardinal(Numero, CultureInfo.CurrentCulture);
    }
