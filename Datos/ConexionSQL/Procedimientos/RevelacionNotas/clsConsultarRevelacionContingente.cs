...
{
    public class clsConsultarRevelacionContingente : clsProcedimientoAlmacenado
    {
        ...
        public clsConsultarRevelacionContingente(string str_IdRevCont, string str_PeriodoAnual, string str_PeriodoMensual)
        {
            ...
            EjecucionSP(str_DireccionConfigs + "\\RevelacionNotas\\ConsultarRevelacionContingente.config", this);
        }
    }
}