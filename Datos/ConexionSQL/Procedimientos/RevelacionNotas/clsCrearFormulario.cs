...
{
    public class clsCrearFormulario : clsProcedimientoAlmacenado
    {
        ...
        public clsCrearFormulario(string str_PeriodoAnual, string str_PeriodoMensual, string str_Institucion,
            string str_PlanCuentas, string str_Concepto, string str_Justificacion,
            string str_NumExpediente, string str_HabilitadaPretencion, string str_EstadoRevelacion, string str_UsrCreacion)

        {
            ...
            EjecucionSP(str_DireccionConfigs + "\\RevelacionNotas\\CrearFormularioExp.config", this);
        }

        public clsCrearFormulario(string str_PeriodoAnual, string str_PeriodoMensual, string str_Institucion,
            string str_Entidad, string str_IdOficina, string str_PlanCuentas, string str_ClaseCuenta, string str_Cuentas,
            string str_Concepto, string str_Justificacion, string str_NumExpediente, string str_HabilitadaPretencion,
            string str_EstadoRevelacion, string str_UsrCreacion,
            string str_RubroCuenta, string str_SubCuenta, string str_SubCuentaAnexa, string str_AuxiliarCuenta)
        {
            ...
            //---------------------------              -----------------
            EjecucionSP(str_DireccionConfigs + "\\RevelacionNotas\\CrearFormulario.config", this);
        }
    }
}