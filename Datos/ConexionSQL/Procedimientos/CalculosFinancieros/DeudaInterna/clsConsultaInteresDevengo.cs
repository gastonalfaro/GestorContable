...
{
    public class clsConsultaInteresDevengo : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsConsultaInteresDevengo(string lstr_NroEmision)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaInterna\\ConsultarInteresDevengo.config", this);
            }
            catch (Exception ex)
            {
