...
{
    public class clsConsultaDevengoMensual : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsConsultaDevengoMensual(string lint_NumValor, string lstr_Nemotecnico)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaInterna\\ConsultarDevengoMensual.config", this);
            }
            catch (Exception ex)
            {
