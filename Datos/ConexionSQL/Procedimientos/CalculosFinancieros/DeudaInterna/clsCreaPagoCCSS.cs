...
{
    public class clsCreaPagoCCSS : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public string Lstr_NroEmisionSerie { get { return lstr_NroEmisionSerie; } set { lstr_NroEmisionSerie = value; } }
        ...
        public clsCreaPagoCCSS(string lstr_EstadoValor, string lstr_Nemotecnico, string lstr_Tipo, string lstr_TipoNegociacion,
            ...
            decimal ldec_RendimientoPorDescuento, decimal ldec_Premio, decimal ldec_ImpuestoPagado, string lstr_Estado, string lstr_ModuloSINPE, string lstr_UsrCreacion)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaInterna\\CrearPagoCCSS.config", this);
            }
            catch (Exception ex)
            {
