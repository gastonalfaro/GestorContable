...
{
    public class clsModificaTituloValor : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsModificaTituloValor(int lint_NumValor, int lint_NumCupon, string lstr_EstadoValor, string lstr_Nemotecnico, string lstr_Tipo, string lstr_TipoNegociacion,
            ...
            string lstr_IndicadorGarantia, string lstr_IndicadorCupon, string lstr_Origen, string lstr_UsrModifica, DateTime ldt_FchModifica)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaInterna\\ModificarTituloValor.config", this);
            }
            catch (Exception ex)
            {
