...
{
    public class clsCreaDevengoMensualCanje : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        {
            get { return lstr_IdentificadorCanje; }
            set { lstr_IdentificadorCanje = value; }
        }
        ...
        public clsCreaDevengoMensualCanje(int lint_NumValor, string lstr_Nemotecnico, string lstr_Periodo, int lint_IdDevengoIntFK, int lint_DiasPeriodo,
            decimal ldec_InteresTotal, decimal ldec_Cupon, decimal ldec_Descuento, string lstr_IdentificadorCanje, string lstr_UsrCreacion, DateTime ldt_FchCanje)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaInterna\\CrearDevengoMensualCanje.config", this);
            }
            catch (Exception ex)
            {
