...
{
    public class clsConsultarAsientosLineas : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsConsultarAsientosLineas(
            ...
            )
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\ConsultarAsientosLineas.config", this);
            }
            catch (Exception ex)
            {
