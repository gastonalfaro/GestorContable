...
{
    public class clsCreaInteres : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsCreaInteres(string lstr_IdPrestamo, int? lint_IdTramo, string lstr_Tasa, DateTime? ldt_FchTasaAPartir, decimal? ldec_TasaMargen, string ldec_Anno,
            ...
            string lstr_Estado, string lstr_UsrCreacion)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\CrearInteres.config", this);
            }
            catch (Exception ex)
            {
