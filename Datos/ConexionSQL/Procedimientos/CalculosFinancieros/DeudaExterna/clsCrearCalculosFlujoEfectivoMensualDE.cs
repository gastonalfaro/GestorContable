...
{
    public class clsCrearCalculosFlujoEfectivoMensualDE : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsCrearCalculosFlujoEfectivoMensualDE(string lstr_IdPrestamo,
        int? lint_IdTramo,
        DateTime? ldt_Fecha,
        ...
        string lstr_UsrCreacion)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\CrearCalculosFlujoEfectivoMensualDE.config", this);
            }
            catch (Exception ex)
            {
