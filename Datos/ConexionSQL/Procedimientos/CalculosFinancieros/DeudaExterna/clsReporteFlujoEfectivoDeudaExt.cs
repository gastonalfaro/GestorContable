...
{
    public class clsReporteFlujoEfectivoDeudaExt : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsReporteFlujoEfectivoDeudaExt(string lstr_IdPrestamo, int? lint_IdTramo, DateTime? ldt_FechaDesde = null, DateTime? ldt_FechaHasta = null)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\ReporteFlujoEfectivoDeudaExt.config", this);
            }
            catch (Exception ex)
            {
