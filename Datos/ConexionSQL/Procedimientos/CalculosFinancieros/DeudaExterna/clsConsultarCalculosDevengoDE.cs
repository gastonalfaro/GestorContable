...
{
    public class clsConsultarCalculosDevengoDE : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsConsultarCalculosDevengoDE(string lstr_IdPrestamo, int? lint_IdTramo, DateTime? ldt_FechaDesde = null, DateTime? ldt_FechaHasta = null)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\ConsultarCalculosDevengoDE.config", this);
            }
            catch (Exception ex)
            {
