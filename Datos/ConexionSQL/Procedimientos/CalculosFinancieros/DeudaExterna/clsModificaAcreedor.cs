...
{
    public class clsModificaAcreedor : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsModificaAcreedor(int lint_NroAcreedor, string lstr_Cedula, string lstr_TipoIdAcreedor, string lstr_NomAcreedor, string lstr_Abreviatura, string lstr_Contacto, string lstr_Telefono,
            ...
            DateTime ldt_FchModifica)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\ModificarAcreedor.config", this);
            }
            catch (Exception ex)
            {
