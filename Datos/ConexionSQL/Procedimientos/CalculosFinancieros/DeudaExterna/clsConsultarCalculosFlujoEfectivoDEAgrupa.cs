...
{
    public class clsConsultarCalculosFlujoEfectivoDEAgrupa : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public DataSet getCalculosFlujoEfectivoDEAgrupa(string lstr_IdPrestamo, int? lint_IdTramo, DateTime? ldt_FechaDesde = null, DateTime? ldt_FechaHasta = null)
        {
        ...
        public clsConsultarCalculosFlujoEfectivoDEAgrupa(string lstr_IdPrestamo, int? lint_IdTramo, DateTime? ldt_FechaDesde = null, DateTime? ldt_FechaHasta = null)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\ConsultarCalculosFlujoEfectivoDEAgrupa.config", this);
            }
            catch (Exception ex)
            {
        ...
        public clsConsultarCalculosFlujoEfectivoDEAgrupa() { }
