...
{
    public class clsCreaCalculoFlujoEfectivoDE : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsCreaCalculoFlujoEfectivoDE(int lint_NumValor, string lstr_Nemotecnico, string lstr_Periodo, decimal ldec_TasaInteres, 
            decimal ldec_Intereses, decimal ldec_FlujoEfectivo, string lstr_UsrCreacion)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\CrearCalculoFlujoEfectivoDE.config", this);
            }
            catch (Exception ex)
            {
