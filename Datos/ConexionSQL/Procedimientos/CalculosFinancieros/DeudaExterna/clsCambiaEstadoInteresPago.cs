...
{
    public class clsCambiaEstadoInteresPago : clsProcedimientoAlmacenado
    {
        #region Parámetros
        ...
        public clsCambiaEstadoInteresPago(string lstr_IdPrestamo, int lint_IdTramo, string lstr_Estado, string lstr_UsrModifica, DateTime ldt_FchModifica)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "CalculosFinancieros\\DeudaExterna\\EstadoInteresPago.config", this);
            }
            catch (Exception ex)
            {
