...
{
    public class clsModificarTipoAsiento : clsProcedimientoAlmacenado
    {
            ...
            string str_CodigoAuxiliar5 = "", string str_CodigoAuxiliar6 = "", int? int_Secuencia = 1)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "\\Mantenimiento\\ModificarTipoAsiento.config", this);
            }
            catch (Exception ex)
            {
