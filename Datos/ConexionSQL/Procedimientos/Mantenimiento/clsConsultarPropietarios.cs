...
{
    public class clsConsultarPropietarios : clsProcedimientoAlmacenado
    {
        ...
        private string lstr_NomExacto;
        public string Lstr_NomExacto
        {
            get { return lstr_NomExacto; }
            set { lstr_NomExacto = value; }
        }

        public clsConsultarPropietarios(string str_IdPropietario, string str_IdSociedadGL, string str_IdSociedadFi, string str_NomPropietario, string str_NomExacto = "N")
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "\\Mantenimiento\\ConsultarPropietarios.config", this);
            }
            catch (Exception ex)
            {
