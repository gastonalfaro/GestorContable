...
{
    public class clsCrearServicio : clsProcedimientoAlmacenado
    {
        ...
        public clsCrearServicio(string str_IdServicio, string str_IdSociedadGL, string str_IdOficina, string str_NomServicio, Nullable<decimal> dec_Monto, string str_PermiteReserva,
            ...
            string str_Estado, string str_UsrCreacion)
        {
            ...
            try
            {
                ...
                EjecucionSP(str_DireccionConfigs + "\\Mantenimiento\\CrearServicio.config", this);
            }
            catch (Exception ex)
            {
