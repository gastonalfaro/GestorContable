...
{
    public class clsBuscarEstadosFinancierosDeudaPublica : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsBuscarEstadosFinancierosDeudaPublica(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\BuscarEstadosFinancierosDeudaPublica.config", this);
        }
        #endregion
