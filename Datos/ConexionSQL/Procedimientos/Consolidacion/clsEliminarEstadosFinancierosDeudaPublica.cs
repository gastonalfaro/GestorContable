...
{
    public class clsEliminarEstadosFinancierosDeudaPublica : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsEliminarEstadosFinancierosDeudaPublica(byte bt_IdEstadoFinanciero, string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\EliminarEstadosFinancierosDeudaPublica.config", this);
        }
        #endregion
