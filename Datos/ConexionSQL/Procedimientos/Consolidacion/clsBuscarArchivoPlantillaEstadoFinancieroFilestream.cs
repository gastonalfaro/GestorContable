...
{
    public class clsBuscarArchivoPlantillaEstadoFinancieroFilestream : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsBuscarArchivoPlantillaEstadoFinancieroFilestream( string str_IdEstadoFinancieroArchivo, string str_Estado, string str_UsrCreacion)
        {
            ...
            try
            {
                ...
                SqlCommand objSqlCmd = new SqlCommand("pc.uspBuscarArchivoPlantillaEstadoFinanciero", objSqlCon, objSqlTran);
                objSqlCmd.CommandType = CommandType.StoredProcedure;

                SqlParameter objSqlParamIdEstadoFinanciero = new SqlParameter("@pIdEstadoFinancieroArchivoPlantilla", SqlDbType.VarChar);
