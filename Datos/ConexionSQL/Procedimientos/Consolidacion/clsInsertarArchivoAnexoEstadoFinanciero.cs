...
{
    public class clsInsertarArchivoAnexoEstadoFinanciero : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsInsertarArchivoAnexoEstadoFinanciero(string str_IdEntidad, int int_IdEstadoFinanciero, int int_Periodo, string str_UnidadTiempoPeriodo, string str_NombreArchivo, string str_TipoArchivo, int int_TamanoByteArchivo, DateTime dt_FechaArchivo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\InsertarArchivoAnexoEstadoFinanciero.config", this);
        }
        #endregion
