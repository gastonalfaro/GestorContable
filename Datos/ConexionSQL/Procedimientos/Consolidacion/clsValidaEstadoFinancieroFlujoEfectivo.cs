...
{
    public class clsValidaEstadoFinancieroFlujoEfectivo : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsValidaEstadoFinancieroFlujoEfectivo(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\ValidaEstadoFinancieroFlujoEfectivo.config", this);
        }
        #endregion
