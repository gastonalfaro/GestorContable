...
{
    public class clsRPTEstadoFinancieroSituacionEvolucionBienesAgregado : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsRPTEstadoFinancieroSituacionEvolucionBienesAgregado(string str_IdAmbitoConsolidacion, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\RPTEstadoFinancieroSituacionEvolucionBienesAgregado.config", this);
        }
        #endregion
