...
{
    public class clsConsultarEstadosFinancierosCargados : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsConsultarEstadosFinancierosCargados(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\ConsultarEstadosFinancierosCargados.config", this);
        }
        #endregion
