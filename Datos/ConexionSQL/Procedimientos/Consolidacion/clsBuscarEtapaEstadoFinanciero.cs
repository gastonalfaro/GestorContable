...
{
    public class clsBuscarEtapaEstadoFinanciero : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsBuscarEtapaEstadoFinanciero(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, DateTime dt_FechaDeEtapaEstado, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\BuscarEtapaEstadoFinanciero.config", this);
        }
        #endregion
