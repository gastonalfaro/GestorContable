...
{
    public class clsRPTEstadoFinancieroFlujoEfectivoAgregado : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsRPTEstadoFinancieroFlujoEfectivoAgregado(string str_IdAmbitoConsolidacion, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\RPTEstadoFinancieroFlujoEfectivoAgregado.config", this);
        }
        #endregion
