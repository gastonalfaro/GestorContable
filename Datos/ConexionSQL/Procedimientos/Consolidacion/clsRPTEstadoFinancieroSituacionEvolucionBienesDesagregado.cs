...
{
    public class clsRPTEstadoFinancieroSituacionEvolucionBienesDesagregado : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsRPTEstadoFinancieroSituacionEvolucionBienesDesagregado(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\RPTEstadoFinancieroSituacionEvolucionBienesDesagregado.config", this);
        }
        #endregion
