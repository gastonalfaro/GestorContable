...
{
    public class clsBuscarArchivoEstadoFinancieroTamanoByte : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsBuscarArchivoEstadoFinancieroTamanoByte(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\BuscarArchivoEstadoFinancieroTamanoByte.config", this);
        }
        #endregion
