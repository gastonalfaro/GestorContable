...
{
    public class clsConsultarCorreosAutorizacionEstadosFinancierosCargados : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsConsultarCorreosAutorizacionEstadosFinancierosCargados(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\ConsultarCorreosAutorizacionEstadosFinancierosCargados.config", this);
        }
        #endregion
