...
{
    public class clsBuscarEstadoFinancieroBalanceComprobacionParaSIGAF : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsBuscarEstadoFinancieroBalanceComprobacionParaSIGAF(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\BuscarEstadoFinancieroBalanceComprobacionParaSIGAF.config", this);
        }
        #endregion
