...
{
    public class clsValidaEstadosFinancierosDeudaPublica : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsValidaEstadosFinancierosDeudaPublica(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\ValidaEstadosFinancierosDeudaPublica.config", this);
        }
        #endregion
