...
{
    public class clsValidaCargaUnidadTiempoPeriodoCorrectoCorreoAutorizacion : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsValidaCargaUnidadTiempoPeriodoCorrectoCorreoAutorizacion(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\ValidaCargaUnidadTiempoPeriodoCorrectoCorreoAutorizacion.config", this);
        }
        #endregion
