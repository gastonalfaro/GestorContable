...
{
    public class clsBuscarEstadoFinancieroBalanceComprobacion : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsBuscarEstadoFinancieroBalanceComprobacion(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\BuscarEstadoFinancieroBalanceComprobacion.config", this);
        }
        #endregion
