...
{
    public class clsConsultarEtapaEstadoFinanciero : clsProcedimientoAlmacenado
    {
        #region variables
        ...
        public clsConsultarEtapaEstadoFinanciero(string str_IdEntidad, int int_Periodo, string str_UnidadTiempoPeriodo, string str_Estado, string str_UsrCreacion)
        {
            ...
            EjecucionSP(lstr_DireccionConfigs + "\\Consolidacion\\ConsultarEtapaEstadoFinanciero.config", this);
        }
        #endregion
