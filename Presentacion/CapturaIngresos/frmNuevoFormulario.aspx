...
<asp:Content ID="Content3" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div class="col-md-12">
        ...
        <b>
            <asp:Label ID="lblCompraDolar" runat="server" Text="Compra Dólares: "></asp:Label></b>
        <asp:Label ID="lblCompraDol" runat="server" Text="0.00"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;
            <b>
                <asp:Label ID="lblVentaDolar" runat="server" Text="Venta Dólares: "></asp:Label></b>
    ...
    <asp:UpdatePanel ID="upPersona1" runat="server">
        <ContentTemplate>
            ...
            <div id="Section" style="width: 100%; display: inline-block;">
                <div class="col-md-12">
                    <h2 style="text-align: center">Información del formulario</h2>
                </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-2">
                        <label style="font-weight: 700">Año</label></div>
                    <div class="col-md-4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-2">
                        <label style="font-weight: 700">Identificación</label></div>
                    <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="col-md-2">
                        <label style="font-weight: 700">Dirección</label></div>
                    <div class="col-md-10">
            ...
            <div class="col-md-10">
                ...
                <div class="col-md-12">
                    <div class="col-md-2" style="padding-right: 0px;">
                        <label style="font-weight: 700">Institución UPR</label></div>
                    <div class="col-md-10">
                ...
                <div class="col-md-12">
                    <div class="col-md-2">
                        <label style="font-weight: 700">Descripción</label></div>
                    <div class="col-md-10">
                ...
                <div class="col-md-12">
                    <div class="col-md-2">
                        <label style="font-weight: 700">En Dólares</label></div>
                    <div class="col-md-2" style="min-height: 24px;">
                ...
                <div id="divFormularioPago">
                    <div class="col-md-12">
                        <h2 style="text-align: center">
                            <asp:Label ID="lblFormPagos" runat="server">Información de Pagos</asp:Label></h2>
                    </div>
    ...
    <div class="col-md-12">
        <div class="col-md-12" style="text-align: center;">
            ...
            <asp:Button ID="btnPrepararImprimir" runat="server" Visible="false" Text="Preparar Impresión" OnClick="btnPrepararImprimir_Click" CssClass="ButtonNeutro" Style="width: 200px;" />
            ...
            <asp:GridView ID="grdDatos" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="BorrarRubro" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Borrar" HeaderImageUrl="~/Compartidas/imagenes/1444297028_Delete.png">
                        <ItemTemplate>
                            <asp:Button ID="btnBorrar" EnableViewState="true" OnClientClick="return confirm('Si elimina la fila, debe de incluirla nuevamente. ¿Seguro que desea eliminar la línea?');" CommandName="Borrar" runat="server" Text="Borrar" BackColor="#3366CC" ForeColor="White" CommandArgument='<%# Container.DataItemIndex %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
