<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/PortalPrincipal.Master" AutoEventWireup="true" CodeBehind="frmFormulariosComprobantes.aspx.cs" Inherits="Presentacion.CapturaIngresos.frmFormulariosComprobantes" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div class="col-md-12">Consulta de Comprobantes de Formularios del Sistema Gestor.</div>
    ...
    <div class="col-md-12">
        <div style="text-align:center;">
               <asp:Button ID="btnFormulariosConsultar" runat="server" Text="CONSULTAR" OnClick="btnFormulariosConsultar_Click" CssClass="ButtonNeutro"/>
                &nbsp<asp:Button ID="btnEnviarAsiento" runat="server" Text="Enviar Asiento" OnClick="btnEnviarAsiento_Click" Visible="True" CssClass="ButtonNeutro" />
        </div>
    </div>
    <div class="col-md-12">
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                            ...
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    ...
                                    <asp:TemplateField HeaderText="Adjunto">
                                        <ItemTemplate>
                                            <input type ="image" onclick="" alt="" src="../Compartidas/imagenes/24x24-paperclip.png" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="">
                                        <ItemTemplate>
                                           <asp:HyperLink runat="server"
                                            NavigateUrl='<%# Eval("IdArchivo", "frmObtenerArchivoCI.aspx?IdArchivo={0}") %>'
