...
{
    public partial class frmReporteBitacoraCI : BASE
    {
        # region Variables
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!strUsuario.Equals(string.Empty))// && (!str_Institucion.Equals(string.Empty)))
                {
                    ...
                    oParametros.Add(new ReportParameter("pIdOperacion", this.txtIdOperacion.Text.Equals(string.Empty) ? null : this.txtIdOperacion.Text, false));
                    oParametros.Add(new ReportParameter("pIdSociedadGL", this.txtIdSociedad.Text.Equals(string.Empty) ? null : this.txtIdSociedad.Text, false));
                    oParametros.Add(new ReportParameter("pIdTransaccion", this.txtIdTransaccion.Text.Equals(string.Empty) ? null : this.txtIdTransaccion.Text, false));
                    oParametros.Add(new ReportParameter("pIdModulo", "CI", false));
                    oParametros.Add(new ReportParameter("pTitulo", "Captura Ingreso", false));
