<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/PortalPrincipal.Master" AutoEventWireup="true" CodeBehind="EntidadesEntregaATiempoEstadosFinancieros.aspx.cs" Inherits="Presentacion.Consolidacion.Reportes.EntidadesEntregaATiempoEstadosFinancieros" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <br />
    <asp:Label ID="Label1" runat="server" Text="Entidades que Entregaron a Tiempo los Estados Financieros."></asp:Label>
