<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/PortalPrincipal.Master" AutoEventWireup="true" CodeBehind="frmCapturaPeriodicaIngresosUPR.aspx.cs" Inherits="Presentacion.CapturaIngresos.Reportes.frmCapturaPeriodicaIngresosUPR" %>
            ...
            <asp:View id="EntregaATiempoView" runat="Server">   
                <div class="col-md-6">					
                    <div class="row">
                        ...
                        <div class="col-md-7"><asp:TextBox ID="txtFechaInicio" runat="server" CssClass="js-date-picker FormatoTextBox"></asp:TextBox>
                 ...
                 <div class="col-md-6">					
                    <div class="row">
                        ...
                        <div class="col-md-7"><asp:TextBox ID="txtFechaFin" runat="server" CssClass="js-date-picker FormatoTextBox"></asp:TextBox>
