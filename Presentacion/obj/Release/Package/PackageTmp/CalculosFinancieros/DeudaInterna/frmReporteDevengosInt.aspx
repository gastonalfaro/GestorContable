<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/PortalPrincipal.Master" AutoEventWireup="true" CodeBehind="frmReporteDevengosInt.aspx.cs" Inherits="Presentacion.CalculosFinancieros.DeudaInterna.frmReporteDevengosInt" EnableEventValidation="false" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="Contenido" runat="server">
    <div id="datos">
        <div style="display: inline-block;">
            <h3>Reporte de Devengos de Intereses:</h3>
            ...
            <div class="col-md-12" style="margin-top: 2%;">
                ...
                <div class="col-md-6">
                    <div class="col-md-5">Número de Valor:</div>
                    <div class="col-md-7">
