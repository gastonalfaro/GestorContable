<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/PortalPrincipal.Master" AutoEventWireup="true" CodeBehind="frmReporteReclasLPCP.aspx.cs" Inherits="Presentacion.CalculosFinancieros.DeudaInterna.frmReporteReclasLPCP" EnableEventValidation="false" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div style="display:inline-block;"> 
        ...
        <h3>Reporte de Títulos Reclasificados de LP a CP:</h3>
        ...
        <div class="col-md-6" style="margin-top: 1%;">
            ...
            <div class="col-md-6"><asp:DropDownList ID="ddlNroValor" runat="server" AppendDataBoundItems="True" AutoPostBack="True"  CssClass="FormatoDropDownList">
         ...
         <div class="col-md-6" style="margin-top: 1%;">
            ...
            <div class="col-md-6">  <asp:DropDownList ID="ddlTipo" runat="server" AppendDataBoundItems="True" AutoPostBack="True"  CssClass="FormatoDropDownList">
                        <asp:ListItem Value="">-- Seleccione Opcion --</asp:ListItem>
       ...
       <%-- <div class="col-md-6">
            <div class="col-md-5">Sistema de Negociación:</div>
            <div class="col-md-7">  
                <asp:DropDownList ID="ddlSistemaNegociacion" runat="server" AppendDataBoundItems="True" AutoPostBack="True"  CssClass="FormatoDropDownList">
                        <asp:ListItem Value="">-- Seleccione Opcion --</asp:ListItem>
        ...
        --%>
           <%-- <div class="col-md-6">
                <div class="col-md-5">Plazo:</div>
                <div class="col-md-7"> <asp:DropDownList runat="server" ID="ddlPlazo" AutoPostBack="True" AppendDataBoundItems="True"  CssClass="chzn-select FormatoDropDownList">
                        <asp:ListItem Value="">-- Seleccione Opcion --</asp:ListItem>
        ...
        <div class="col-md-12" style="text-align:center; margin-top:3%;" id="ImprimirRep"> 
