<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/PortalPrincipal.Master" AutoEventWireup="true" CodeBehind="frmTrasladosMagisterio.aspx.cs" Inherits="Presentacion.CalculosFinancieros.DeudaInterna.frmTrasladosMagisterio" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="Contenido" runat="server">
    <div>
        <h3>Cargar información: Traslado de cuotas al Magisterio</h3>
        <table style="width: 100%;">
            <tr>
                <td colspan="3">
                    ...
                    <br />
                    <b>Nota Importante:</b> Al descargar el archivo, reemplace (en el nombre del archivo) la palabra plantilla, por su número de cédula. Incluya ceros sin espacios. Ej: Magisterio_0109990888.
                </td>
            </tr>
            <tr>
                <td>
        ...
        <div style="overflow-x: auto; width: auto" align="center">
            <asp:GridView ID="grvMagisterio" runat="server" CellPadding="4" ForeColor="#333333" AllowPaging="True" OnPageIndexChanging="grvCCSS_PageIndexChanging" Font-Size="X-Small" PageSize="20"
