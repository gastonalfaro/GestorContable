...
{
    public partial class frmCargaEntidad : BASE
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(MethodInfo.GetCurrentMethod().Name + " - " + ex.Message.ToString());
                #region MensajeError
        ...
        public DataSet GetDataSetGridView_ConsultarEstadosFinancierosCargados()
        {
            ...
            try
            {
                string strIdEntidad, strPeriodo, strUnidadTiempoPeriodo;
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    dsNICSPDatosGridView = WSINICSP_PC.ConsultarEstadoFinancierosCargados(strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo, "", gstr_Usuario, out Resultado, out Mensaje);
        ...
        public DataSet GetDataSetGridView_ConsultarArchivosAnexosEstadosFinancierosCargados()
        {
            ...
            try
            {
                string strIdEntidad, strPeriodo, strUnidadTiempoPeriodo, Resultado, Mensaje; ;
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    dsNICSPDatosGridView = WSINICSP_PC.ConsultarArchivosAnexosEstadosFinancierosCargados(strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo, "", gstr_Usuario, out Resultado, out Mensaje);
        ...
        public DataSet GetDataSetGridView_ConsultarArchivosPlantillasEstadosFinancierosCargados()
        {
            ...
            try
            {
                ...
                dsNICSPDatosGridView = WSINICSP_PC.ConsultarArchivosPlantillasEstadosFinancierosCargados("", gstr_Usuario, out Resultado, out Mensaje);
        ...
        public DataSet GetDataSetGridView_ConsultarCorreosAutorizacionEstadosFinancierosCargados()
        {
            ...
            try
            {
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    dsNICSPDatosGridView = WSINICSP_PC.ConsultarCorreosAutorizacionEstadosFinancierosCargados(strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo, "", gstr_Usuario, out Resultado, out Mensaje);
        ...
        protected void EstadosFinancierosArchivosGridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                if (EtadaActual.Equals("0") || EtadaActual.Equals("1"))
                {
                    ...
                    if (gstr_Institucion.Equals(strIdEntidad) || gstr_Institucion.Equals("11206"))
                    //if(gstr_Institucion.Equals(strIdEntidad))  //gaston cucurucho
                    { //gaston cucurucho
                    ...
                    else //gaston cucurucho
                    { //gaston cucurucho
                        DesplegarError(true); //gaston cucurucho
                        txtError.Text = txtError.Text + "\r\n" +  ConfigurationManager.AppSettings["strErrorNoConcuerdaIdInstitucion"].ToString(); //gaston cucurucho
                    } //gaston cucurucho
                }
                else
                {
        ...
        protected void CargarArchivosButton_Click(object sender, EventArgs e)
        {
            ...
            DataSet dsNICSPDatos = new DataSet();
            wsPlantillasConsolidacion WSINICSP_PC = new wsPlantillasConsolidacion();
            //MessageBox.Show("Inicio de carga de archivo");
            ...
            //MessageBox.Show("bufferFlujoEfectivo");
            ...
            //MessageBox.Show("bufferCambioPatrimonioNeto");
            ...
            //MessageBox.Show("bufferBalanceComprobacion");
            ...
            //MessageBox.Show("bufferDeudaPublica");
            ...
            //MessageBox.Show("bufferEstadoVarios");
            ...
            //MessageBox.Show("bufferNotasEstadosFinancieros");
            try
            {
              //  MessageBox.Show("Inicio de definicion de variables");
                ...
                //MessageBox.Show("Variables de configuration manager");
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    DataSet dsRegistrosIngresados = ws_SGService.uwsConsultarDinamico("SELECT count(*) FROM pc.EstadosFinancierosBalanceComprobacion "+
                                                                                    "WHERE IdEntidad = '" + strIdEntidad + "'" +
                                                                                    " AND Periodo = " + strPeriodo +
                                                                                    " AND UnidadTiempoPeriodo = '" + strUnidadTiempoPeriodo + "'");

                                                    if (Int32.Parse(dsRegistrosIngresados.Tables[0].Rows[0][0].ToString()) == 0) 
                                                    {
                                                        if (DesplegarError(!Eliminar_ArchivoEstadoFinanciero(IdEstadoFinancieroArchivo)))
                                                        {
                                                            txtError.Text = txtError.Text + "\r\n" + ConfigurationManager.AppSettings["strErrorBorrarArchivo"].ToString() + " " + IdEstadoFinancieroArchivo;
                                                        }
                                                        txtError.Text += "\n Antes de subir la balanza asegúrese que abrió el excel, revisó la información y le dió guardar, para evitar problemas por cambios de directorios.";
           ...
           //     MessageBox.Show(ex.Message.ToString()+"\n" +ex.StackTrace.ToString());
                string error = MethodInfo.GetCurrentMethod().Name + ": Excepcion  " + ex.Message.ToString() + "\n" + ex.StackTrace.ToString();
                txtError.Text = txtError.Text +"\n"+error;
                #region MensajeError
                //MessageBox.Show(error);
                //if (!EventLog.SourceExists(ConfigurationManager.AppSettings["EventLogSource"].ToString()))
                //{
                //    EventLog.CreateEventSource(ConfigurationManager.AppSettings["EventLogSource"].ToString(), "Log");
                //}
                //EventLog.WriteEntry(ConfigurationManager.AppSettings["EventLogSource"].ToString(),
                //    //Obtiene el nombre de la clase.
                //"NICSP"
                ...
                var frame = st.GetFrames().Where(f => !String.IsNullOrEmpty(f.GetFileName())
                ...
                mensaje += "\n Mensaje " + ex.Message;
                mensaje += "\n LineaError " + frame.GetFileLineNumber();
                mensaje += "\n Proyecto " + frame.GetMethod().Module.Assembly.GetName().Name;
                mensaje += "\n Clase " + frame.GetMethod().DeclaringType.Name;
                mensaje += "\n Metodo " + frame.GetMethod().Name;
                mensaje += "\n CodigoError " + frame.GetHashCode().ToString();
        ...
        protected void CargarArchivosAnexosButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string strIdEntidad, strPeriodo, strUnidadTiempoPeriodo, strEstadoFinanciero;
                ...
                if (ArchivoAnexoFileUpload.FileContent.Length > 0)
                {
                    ...
                    {
                        //if(gstr_Institucion.Equals(strIdEntidad))
                        //{
                        ...
                        //{
                        //    DesplegarError(true);
                        //    txtError.Text = txtError.Text + "\r\n" +  ConfigurationManager.AppSettings["strErrorNoConcuerdaIdInstitucion"].ToString());
                        //}
                    }
                    else
                    {
        ...
        //    try
        //    {
        //        string gstr_Usuario/*, strIdEntidad, strPeriodo, strUnidadTiempoPeriodo*/, strEstadoFinanciero;
        //        string strNombreArchivo, Resultado, Mensaje;
        //        string IdEstadoFinancieroArchivo = "", NombreArchivo = "", TipoArchivo = "";
        //        bool bCargaArchivo = false;

        //        gstr_Usuario = gstr_Usuario;
        ...
        //        if (!txtError.Items.Count.Equals(0))
        //        {
        //            DesplegarError(true);
        //        }
        ...
        protected void RevisionInstitucionButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string gstr_Usuario, strIdEntidad, strPeriodo, strUnidadTiempoPeriodo;
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    if (!DesplegarError(!bCambioEstado))
                    {
                        ...
                        else
                        {
                            ...
                            str_Asunto = str_Asunto.Replace("XXXXXXX", gstr_Institucion);
                            ...
                            //if (!dsNICSPDatosDropDownList.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                            {
                                //string str_Aux_CorreoTo;

                                for (int i = 0; i <= dsNICSPDatos.Tables["Table"].Rows.Count - 1; i++)
                                {
                                    //str_Aux_CorreoTo = string.IsNullOrEmpty(str_CorreoTo) ? "" : str_CorreoTo;
                                    //str_CorreoTo = str_Aux_CorreoTo + dsNICSPDatos.Tables["Table"].Rows[i]["CorreoUsuario"].ToString() + ", ";
                            ...
                            //MessageBox.Show("Proceso Ejecutado"); //gaston agregado de prueba
                        }
                    }
                }
                else
        ...
        public string ValidarVisibilidadEstadosEtapas()
        {
            ...
            try
            {
                string strIdEntidad, strPeriodo, strUnidadTiempoPeriodo, IdEtapaEstadoFinanciero = "0";
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    {
                        if (dsNICSPDatos.Tables.Count > 0 && dsNICSPDatos.Tables["Table"].Rows.Count > 0)//Si hizo la consulta pero No retorno Null                   
                        {
                            if (!dsNICSPDatos.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                            {
        ...
        protected void EstadosFinancierosArchivosPlantillasGridView_SelectedIndexChanged(object sender, EventArgs e)
        {
