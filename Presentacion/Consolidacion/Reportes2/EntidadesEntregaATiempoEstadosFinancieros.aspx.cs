...
{
    public partial class EntidadesEntregaATiempoEstadosFinancieros : System.Web.UI.Page
    {
        ...
        protected void VerReporteButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if ((!strUsuario.Equals(string.Empty)) && (!strIdEntidad.Equals(string.Empty)))
                {
                    ...
                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteEntidadesEntregaATiempoEstadosFinancieros"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
