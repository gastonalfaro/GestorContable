<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/PortalPrincipal.Master" AutoEventWireup="true" CodeBehind="EntidadesEntregaRechazadaEstadosFinancieros.aspx.cs" Inherits="Presentacion.Consolidacion.Reportes.EntidadesEntregaRechazadaEstadosFinancieros" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <br />
    <asp:Label ID="Label1" runat="server" Text="Entidades que Entregaron y Fueron Rechazados sus Estados Financieros."></asp:Label>
