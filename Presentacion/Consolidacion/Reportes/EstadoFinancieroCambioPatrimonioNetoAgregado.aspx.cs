...
{
    public partial class EstadoFinancieroCambioPatrimonioNetoAgregado : BASE
    {
        ...
        protected void VerReporteButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (/*(!strIdEntidad.Equals(string.Empty)) &&*/ (!strPeriodo.Equals(string.Empty)) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteEstadoFinancieroCambioPatrimonioNetoAgregado"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
