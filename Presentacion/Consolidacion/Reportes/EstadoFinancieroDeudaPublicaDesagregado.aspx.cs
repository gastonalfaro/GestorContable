...
{
    public partial class EstadoFinancieroDeudaPublicaDesagregado : BASE
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    DeudaPublicaDesagregadoMultiView.ActiveViewIndex = 0;
                }
            }
            catch (Exception ex)
            {
        ...
        protected void ViewDeudaPublicaDesagregadoLinkButton_Click(object sender, EventArgs e)
        {
            DeudaPublicaDesagregadoMultiView.ActiveViewIndex = 0;
        ...
        {
            DeudaPublicaDesagregadoMultiView.ActiveViewIndex = 1;
        }
        ...
        protected void VerReporteButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (/*(!strUsuario.Equals(string.Empty)) &&*/ /*(!strIdEntidad.Equals(string.Empty))*/ (!strPeriodo.Equals(string.Empty)) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteEstadoFinancieroDeudaPublicaDesagregado"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
                    ...
                    DeudaPublicaDesagregadoMultiView.ActiveViewIndex = 1;
                    this.ViewDeudaPublicaDesagregadoLinkButton.Visible = true;
                    this.ViewReporteLinkButton.Visible = true;
                    this.SeparadorDeudaPublicaDesagregadoReporteLabel.Visible = true;
                }
                else
                {
