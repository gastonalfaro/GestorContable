...
{
    public partial class EstadoFinancieroFlujoEfectivoDesagregadoPorAmbitoConsolidacionNumCuenta : BASE
    {
        ...
        protected void VerReporteButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (/*(!strIdEntidad.Equals(string.Empty)) &&*/ (!strPeriodo.Equals(string.Empty)) && (!strUnidadTiempoPeriodo.Equals(string.Empty)) && (!strNumCuenta.Equals(string.Empty)))
                {
                    ...
                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteEstadoFinancieroFlujoEfectivoDesagregadoPorAmbitoConsolidacionNumCuenta"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
