...
{
    public partial class EstadoFinancieroDeudaPublicaDesagregadoPorAmbitoConsolidacionNumConsecutivo : BASE
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    EstadoFinancieroDeudaPublicaDesagregadoPorAmbitoConsolidacionNumConsecutivoMultiView.ActiveViewIndex = 0;
                }
            }
            catch (Exception ex)
            {
        ...
        protected void ViewEstadoFinancieroDeudaPublicaDesagregadoPorAmbitoConsolidacionNumConsecutivoLinkButton_Click(object sender, EventArgs e)
        {
            EstadoFinancieroDeudaPublicaDesagregadoPorAmbitoConsolidacionNumConsecutivoMultiView.ActiveViewIndex = 0;
        ...
        {
            EstadoFinancieroDeudaPublicaDesagregadoPorAmbitoConsolidacionNumConsecutivoMultiView.ActiveViewIndex = 1;
        }
        ...
        protected void VerReporteButton_Click(object sender, EventArgs e)
        {
            try
            {
                string strUsuario, strIdEntidad, strAmbitoConsolidacion, strPeriodo, strUnidadTiempoPeriodo, strNumCuenta;

                //strUsuario = User.Identity.Name;
                strUsuario = gstr_Usuario;
                strIdEntidad = AmbitoConsolidacionDropDownList.SelectedValue;
                strAmbitoConsolidacion = AmbitoConsolidacionDropDownList.SelectedItem.Text;
                strPeriodo = PeriodoDropDownList.SelectedItem.Text;
                strUnidadTiempoPeriodo = UnidadTiempoPeriodoDropDownList.SelectedValue;
                strNumCuenta = NumCuentaTextBox.Text;

                //ParametrosReporte oParam = new ParametrosReporte();
                List<ReportParameter> oParametros = new List<ReportParameter>();

                if (/*(!strIdEntidad.Equals(string.Empty)) &&*/ (!strPeriodo.Equals(string.Empty)) && (!strUnidadTiempoPeriodo.Equals(string.Empty)) && (!strNumCuenta.Equals(string.Empty)))
                {
                    ...
                    oParametros.Add(new ReportParameter("AmbitoConsolidacion", strAmbitoConsolidacion, false));
                    ...
                    oParametros.Add(new ReportParameter("NumCuenta", strNumCuenta, false));

                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteEstadoFinancieroCambioPatrimonioNetoDesagregadoPorAmbitoConsolidacionNumCuenta"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
                    ...
                    EstadoFinancieroDeudaPublicaDesagregadoPorAmbitoConsolidacionNumConsecutivoMultiView.ActiveViewIndex = 1;
                    this.ViewEstadoFinancieroDeudaPublicaDesagregadoPorAmbitoConsolidacionNumConsecutivoLinkButton.Visible = true;
                    this.ViewReporteLinkButton.Visible = true;
                    this.SeparadorEstadoFinancieroDeudaPublicaDesagregadoPorAmbitoConsolidacionNumConsecutivoReporteLabel.Visible = true;
                }
                else
                {
