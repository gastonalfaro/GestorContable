...
{
    public partial class frmRevisionAnalista : BASE
    {
        ...
        public DataSet GetDataSetGridView_ConsultarEstadosFinancierosCargados()
        {
            ...
            try
            {
                ...
                string CodigoEstadosFinancieros_EstadoFlujoEfectivo, CodigoEstadosFinancieros_EstadoCambioPatrimonioNeto,
                    CodigoEstadosFinancieros_ConsolidacionNotas, CodigoEstadosFinancieros_EstadoBalanceComprobacion, CodigoEstadosFinancieros_EstadoDeudaPublica, CodigoEstadosFinancieros_EstadoVarios;
                ...
                CodigoEstadosFinancieros_EstadoDeudaPublica = ConfigurationManager.AppSettings["CodigoEstadosFinancieros_EstadoDeudaPublica"].ToString();
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    //{
                    //if (dsNICSPDatosGridView.Tables.Count > 0  && dsNICSPDatos.Tables["Table"].Rows.Count > 0)//Si hizo la consulta pero No retorno nada
                    if (!dsNICSPDatosGridView.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                    {
                        ...
                        DeudaPublicaFileUpload.Enabled = true;
                                    ...
                                    if (strAuxCod.Equals(CodigoEstadosFinancieros_EstadoCambioPatrimonioNeto))
                                        ...
                                        if (strAuxCod.Equals(CodigoEstadosFinancieros_ConsolidacionNotas))
                                            ...
                                            if (strAuxCod.Equals(CodigoEstadosFinancieros_EstadoBalanceComprobacion))
                                                ...
                                                if (strAuxCod.Equals(CodigoEstadosFinancieros_EstadoDeudaPublica))
                                                    DeudaPublicaFileUpload.Enabled = false;
                                                else
                        ...
                        //else
                        //    RevisionInstitucionButton.Enabled = false;
                        if ((FlujoEfectivoFileUpload.Enabled.Equals(true)) || (CambioPatrimonioNetoFileUpload.Enabled.Equals(true)) || (NotasEstadosFinancierosFileUpload.Enabled.Equals(true)) || (BalanceComprobacionFileUpload.Enabled.Equals(true)) || (DeudaPublicaFileUpload.Enabled.Equals(true)) || (EstadoVariosFileUpload.Enabled.Equals(true)))
                            RevisionInstitucionButton.Enabled = false;
                        else
                        {
                            if ((EtadaActual.Equals("0")) || (EtadaActual.Equals("1")))
                                RevisionInstitucionButton.Enabled = true;
                        }
                    }
                    else
        ...
        public DataSet GetDataSetGridView_ConsultarArchivosAnexosEstadosFinancierosCargados()
        {
            ...
            try
            {
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    //if (dsNICSPDatosGridView.Tables["Result"].Rows[0]["status"].ToString() == "00")
                    //{
                    if (dsNICSPDatosGridView.Tables.Count > 0 && dsNICSPDatosGridView.Tables["Table"].Rows.Count > 0)//Si hizo la consulta pero No retorno nada
                    //if (!dsNICSPDatosGridView.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                    {
                        for (int i = 0; i <= dsNICSPDatosGridView.Tables["Table"].Rows.Count - 1; i++)
                        {
        ...
        protected void EstadosFinancierosArchivosGridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                if (EtadaActual.Equals("5"))
                {
                    ...
                    {
                        txtError.Text = txtError.Text + "\r\n" + ConfigurationManager.AppSettings["strErrorBorrarArchivo"].ToString() + " " + strIdEstadoFinancieroArchivo;
                    }
                    else
                    {
                        ...
                        {
                            txtError.Text = txtError.Text + "\r\n" + ConfigurationManager.AppSettings["strErrorBorrarArchivo"].ToString() + " " + strIdEstadoFinanciero + " " + strIdEntidad + " " + strUnidadTiempoPeriodo + " " + strPeriodo;
                        }
                    }
                ...
                {
                    DesplegarError(true);
                    txtError.Text = txtError.Text + "\r\n" + ConfigurationManager.AppSettings["strErrorBorrarArchivoEtapaNovalida2"].ToString();
                }
            }
            catch (Exception ex)
            {
        ...
        protected Boolean Eliminar_EstadoFinanciero(string IdEstadoFinanciero, string IdEntidad, int Periodo, string UnidadTiempoPeriodo)
        {
            ...
            try
            {
                ...
                string CodigoEstadosFinancieros_EstadoFlujoEfectivo, CodigoEstadosFinancieros_EstadoCambioPatrimonioNeto, CodigoEstadosFinancieros_EstadoBalanceComprobacion, CodigoEstadosFinancieros_EstadoDeudaPublica;
                ...
                if (CodigoEstadosFinancieros_EstadoFlujoEfectivo.Equals(IdEstadoFinanciero.ToString()))
                {
                    ...
                    if (CodigoEstadosFinancieros_EstadoCambioPatrimonioNeto.Equals(IdEstadoFinanciero.ToString()))
                    {
                        ...
                        if (CodigoEstadosFinancieros_EstadoBalanceComprobacion.Equals(IdEstadoFinanciero.ToString()))
                        {
                            ...
                            if (CodigoEstadosFinancieros_EstadoDeudaPublica.Equals(IdEstadoFinanciero.ToString()))
                            {
                                boolEliminado = WSINICSP_PC.EliminarEstadoFinancieroDeudaPublica(byte.Parse(IdEstadoFinanciero), IdEntidad, Periodo, UnidadTiempoPeriodo, "", gstr_Usuario, out Resultado, out Mensaje);
                            }
                            else
                                {
                                    boolEliminado = true;
            ...
            try
            {
                ...
                if (e.CommandName == "Select")
                {
                    ...
                    if ((!strIdEstadoFinancieroArchivosAnexos.Equals(string.Empty)))
                    {
                        ...
                        if (dsNICSPDatos.Tables.Count > 0 && dsNICSPDatos.Tables["Table1"].Rows.Count > 0)//Si hizo la consulta pero No retorno nada
                        //if (!dsNICSPDatosGridView.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                        {
            ...
            try
            {
                if (e.CommandName == "Select")
                {
                    ...
                    if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                    {
                        ...
                        //if (dsNICSPDatos.Tables.Count > 0 && dsNICSPDatos.Tables["Table"].Rows.Count > 0)//Si hizo la consulta pero No retorno nada
                        ////if (!dsNICSPDatosGridView.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                        //{
        ...
        public DataSet GetDataSetDropDownList_ConsultarCatalogoAmbitoConsolidacion()
        {
            ...
            try
            {
                ...
                //{
                if (dsNICSPDatosDropDownList.Tables.Count > 0 && dsNICSPDatosDropDownList.Tables["Table"].Rows.Count > 0)//Si hizo la consulta pero No retorno nada
        ...
        protected void CargarArchivosButton_Click(object sender, EventArgs e)
        {
            ...
            byte[] bufferDeudaPublica = new byte[(int)DeudaPublicaFileUpload.FileContent.Length];
            DeudaPublicaFileUpload.FileContent.Read(bufferDeudaPublica, 0, bufferDeudaPublica.Length);
            ...
            {
                string strUsuario, strIdEntidad, strPeriodo, strUnidadTiempoPeriodo;
                strUsuario = strIdEntidad = strPeriodo = strUnidadTiempoPeriodo = string.Empty;
                string strExcelIdEntidad, strExcelPeriodo, strExcelUnidadTiempoPeriodo;
                strExcelIdEntidad = strExcelPeriodo = strExcelUnidadTiempoPeriodo = string.Empty;
                string strNombreArchivo, strInfoNombreArchivo;
                strNombreArchivo = strInfoNombreArchivo = string.Empty;
                string CodigoEstadosFinancieros_EstadoFlujoEfectivo, CodigoEstadosFinancieros_EstadoCambioPatrimonioNeto,
                    CodigoEstadosFinancieros_ConsolidacionNotas, CodigoEstadosFinancieros_EstadoBalanceComprobacion, CodigoEstadosFinancieros_EstadoDeudaPublica, CodigoEstadosFinancieros_EstadoVarios;
                CodigoEstadosFinancieros_EstadoFlujoEfectivo = CodigoEstadosFinancieros_EstadoCambioPatrimonioNeto =
                    CodigoEstadosFinancieros_ConsolidacionNotas = CodigoEstadosFinancieros_EstadoBalanceComprobacion = CodigoEstadosFinancieros_EstadoDeudaPublica = CodigoEstadosFinancieros_EstadoVarios = string.Empty;
                string NombreArchivo = "", TipoArchivo = "";
                string strJobFolder = "", strJobProjBalance = "", strJobProjPatrimonio = "", strJobProjDescarga = "", strJobProjDeuda = "", strJobProjFlujo = "";
                bool bCargaArchivo = false;
                string VarDTSX = "", Resultado = "", Mensaje = "", DTSX_PaqueteURL = "", DTSX_RutaDescargaArchivo = "", DTSX_DescargaArchivoEnServer = "", DTSX_CargaEstadoFinancieroFlujoEfectivo = "", DTSX_CargaEstadoFinancieroCambioPatrimonioNeto = "", DTSX_CargaEstadoFinancieroBalanceComprobacion = "", DTSX_CargaEstadosFinancierosDeudaPublica = "", DTSX_Ruta32Bit = "";
                string IdEstadoFinancieroArchivo = "";
                bool Run64BitRuntime_DTSX_DescargaArchivoEnServer = false, Run64BitRuntime_DTSX_CargaEstadoFinancieroFlujoEfectivo = false, Run64BitRuntime_DTSX_CargaEstadoFinancieroCambioPatrimonioNeto = false, Run64BitRuntime_DTSX_CargaEstadoFinancieroBalanceComprobacion = false, Run64BitRuntime_DTSX_CargaEstadosFinancierosDeudaPublica = false;
                string[] str_res;
                gstr_Usuario = clsSesion.Current.LoginUsuario;
                gstr_Institucion = clsSesion.Current.SociedadUsr;
                ...
                strPeriodo = PeriodoDropDownList.SelectedItem.Text;
                strUnidadTiempoPeriodo = UnidadTiempoPeriodoDropDownList.SelectedValue;
                bool blnDTSX_EjecucionJob = false;

                blnDTSX_EjecucionJob = bool.Parse(ConfigurationManager.AppSettings["DTSX_EjecucionJob"].ToString());
                CodigoEstadosFinancieros_EstadoFlujoEfectivo = ConfigurationManager.AppSettings["CodigoEstadosFinancieros_EstadoFlujoEfectivo"].ToString();
                CodigoEstadosFinancieros_EstadoCambioPatrimonioNeto = ConfigurationManager.AppSettings["CodigoEstadosFinancieros_EstadoCambioPatrimonioNeto"].ToString();
                CodigoEstadosFinancieros_EstadoBalanceComprobacion = ConfigurationManager.AppSettings["CodigoEstadosFinancieros_EstadoBalanceComprobacion"].ToString();
                CodigoEstadosFinancieros_EstadoDeudaPublica = ConfigurationManager.AppSettings["CodigoEstadosFinancieros_EstadoDeudaPublica"].ToString();
                ...
                strJobFolder = ConfigurationManager.AppSettings["DTSX_JobFolder"].ToString();
                strJobProjDescarga = ConfigurationManager.AppSettings["DTSX_JobProjectDescarga"].ToString();
                strJobProjFlujo = ConfigurationManager.AppSettings["DTSX_JobProjectFlujo"].ToString();
                strJobProjPatrimonio = ConfigurationManager.AppSettings["DTSX_JobProjectPatrimonio"].ToString();
                strJobProjBalance = ConfigurationManager.AppSettings["DTSX_JobProjectBalance"].ToString();
                strJobProjDeuda = ConfigurationManager.AppSettings["DTSX_JobProjectDeuda"].ToString();
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    //if (!dsNICSPDatosDropDownList.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                    {
                        ...
                        DTSX_Ruta32Bit = ConfigurationManager.AppSettings["DTSX_Ruta32Bit"].ToString();
                        ...
                        if (bCargaUnidadTiempoPeriodoValido)
                        {
                                ...
                                if (strIdEntidad.Equals(strExcelIdEntidad) && strPeriodo.Equals(strExcelPeriodo) && strUnidadTiempoPeriodo.Equals(strExcelUnidadTiempoPeriodo))
                                {
                                    if (validaSize(bufferFlujoEfectivo.Length, strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo))
                                    {
                                        ...
                                        if (DesplegarError(!bCargaArchivo))
                                        {
                                            ...
                                            {
                                                txtError.Text = txtError.Text + "\r\n" + ConfigurationManager.AppSettings["strErrorBorrarArchivo"].ToString() + " " + IdEstadoFinancieroArchivo;
                                            }
                                            DesplegarError(true);
                                        ...
                                        else
                                        {
                                            ...
                                            if (blnDTSX_EjecucionJob)
                                            {
                                                str_res = WSINICSP_PC.uwsEjecutarDTSXBD(DTSX_RutaDescargaArchivo, DTSX_DescargaArchivoEnServer, IdEstadoFinancieroArchivo, !Run64BitRuntime_DTSX_DescargaArchivoEnServer, DTSX_Ruta32Bit, "", gstr_Usuario, strJobFolder, strJobProjDescarga, out Resultado, out Mensaje);
                                                //Resultado = str_res[0];
                                                //Mensaje = str_res[1];
                                            }
                                            else
                                            {
                                                str_res = WSINICSP_PC.uwsEjecutarDTSX(DTSX_PaqueteURL, DTSX_DescargaArchivoEnServer, VarDTSX, Run64BitRuntime_DTSX_DescargaArchivoEnServer, DTSX_Ruta32Bit, "", gstr_Usuario, out Resultado, out Mensaje);
                                            }
                                            ...
                                            else
                                            {
                                                ...
                                                if (blnDTSX_EjecucionJob)
                                                {
                                                    str_res = WSINICSP_PC.uwsEjecutarDTSXBD(DTSX_RutaDescargaArchivo, DTSX_CargaEstadoFinancieroFlujoEfectivo, strNombreArchivo, !Run64BitRuntime_DTSX_CargaEstadoFinancieroFlujoEfectivo, DTSX_Ruta32Bit, "", gstr_Usuario, strJobFolder, strJobProjFlujo, out Resultado, out Mensaje);
                                                }
                                                else
                                                {
                                                    str_res = WSINICSP_PC.uwsEjecutarDTSX(DTSX_PaqueteURL, DTSX_CargaEstadoFinancieroFlujoEfectivo, VarDTSX, Run64BitRuntime_DTSX_CargaEstadoFinancieroFlujoEfectivo, DTSX_Ruta32Bit, "", gstr_Usuario, out Resultado, out Mensaje);
                                                }
                                                ...
                                                if (DesplegarError(!Resultado.Equals("00")))
                                                {
                                                    ...
                                                    {
                                                        txtError.Text = txtError.Text + "\r\n" + ConfigurationManager.AppSettings["strErrorBorrarArchivo"].ToString() + " " + CodigoEstadosFinancieros_EstadoFlujoEfectivo + " " + strIdEntidad + " " + strUnidadTiempoPeriodo + " " + strPeriodo;
                                                    }
                                                ...
                                                {
                                                    if (!Eliminar_Archivo(DTSX_RutaDescargaArchivo, strNombreArchivo, out Mensaje))
                                                    {
                                                        DesplegarError(true);
                                                        txtError.Text = txtError.Text + "\r\n" + Mensaje;
                                                    }
                                    ...
                                    if (validaSize(bufferCambioPatrimonioNeto.Length, strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo))
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (blnDTSX_EjecucionJob)
                                                {
                                                    str_res = WSINICSP_PC.uwsEjecutarDTSXBD(DTSX_RutaDescargaArchivo, DTSX_CargaEstadoFinancieroCambioPatrimonioNeto, strNombreArchivo, !Run64BitRuntime_DTSX_CargaEstadoFinancieroCambioPatrimonioNeto, DTSX_Ruta32Bit, "", gstr_Usuario, strJobFolder, strJobProjPatrimonio, out Resultado, out Mensaje);
                                                }
                                                else
                                                {
                                                    str_res = WSINICSP_PC.uwsEjecutarDTSX(DTSX_PaqueteURL, DTSX_CargaEstadoFinancieroCambioPatrimonioNeto, VarDTSX, Run64BitRuntime_DTSX_CargaEstadoFinancieroCambioPatrimonioNeto, DTSX_Ruta32Bit, "", gstr_Usuario, out Resultado, out Mensaje);
                                                }
                                                ///*dsNICSPDatos*/ string asd = WSINICSP_PC.uwsPrueba2("", ""/*,out Resultado, out Mensaje*/);
                                                //dsNICSPDatos = WSINICSP_PC.ValidarEstadoFinancieroFlujoEfectivo(strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo, "", gstr_Usuario, out Resultado, out Mensaje);
                                                ...
                                                if (DesplegarError(!Resultado.Equals("00")))
                                                {
                                                    ...
                                                    {
                                                        txtError.Text = txtError.Text + "\r\n" + ConfigurationManager.AppSettings["strErrorBorrarArchivo"].ToString() + " " + CodigoEstadosFinancieros_EstadoCambioPatrimonioNeto + " " + strIdEntidad + " " + strUnidadTiempoPeriodo + " " + strPeriodo;
                                                    }
                            ...
                            {
                                if (CambioPatrimonioNetoFileUpload.Enabled)
                                {
                                    DesplegarError(true);
                                    ...
                                    if (validaSize(bufferBalanceComprobacion.Length, strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo))
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (blnDTSX_EjecucionJob)
                                                {
                                                    str_res = WSINICSP_PC.uwsEjecutarDTSXBD(DTSX_RutaDescargaArchivo, DTSX_CargaEstadoFinancieroBalanceComprobacion, strNombreArchivo, !Run64BitRuntime_DTSX_CargaEstadoFinancieroBalanceComprobacion, DTSX_Ruta32Bit, "", gstr_Usuario, strJobFolder, strJobProjBalance, out Resultado, out Mensaje);
                                                }
                                                else
                                                {
                                                    str_res = WSINICSP_PC.uwsEjecutarDTSX(DTSX_PaqueteURL, DTSX_CargaEstadoFinancieroBalanceComprobacion, VarDTSX, Run64BitRuntime_DTSX_CargaEstadoFinancieroBalanceComprobacion, DTSX_Ruta32Bit, "", gstr_Usuario, out Resultado, out Mensaje);
                                                }
                                                ///*dsNICSPDatos*/ string asd = WSINICSP_PC.uwsPrueba2("", ""/*,out Resultado, out Mensaje*/);
                                                //dsNICSPDatos = WSINICSP_PC.ValidarEstadoFinancieroFlujoEfectivo(strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo, "", gstr_Usuario, out Resultado, out Mensaje);
                                                ...
                                                if (DesplegarError(!Resultado.Equals("00")))
                                                {
                                                    ...
                                                    {
                                                        txtError.Text = txtError.Text + "\r\n" + ConfigurationManager.AppSettings["strErrorBorrarArchivo"].ToString() + " " + CodigoEstadosFinancieros_EstadoBalanceComprobacion + " " + strIdEntidad + " " + strUnidadTiempoPeriodo + " " + strPeriodo;
                                                    }
                            ...
                            /*Deuda Pública*/
                            if (DeudaPublicaFileUpload.FileContent.Length > 0)
                            {
                                strNombreArchivo = DeudaPublicaFileUpload.FileName;
                                //14110T12016_ESTADO_DEUDA_PUBLICA.xlsx
                                ...
                                if (strIdEntidad.Equals(strExcelIdEntidad) && strPeriodo.Equals(strExcelPeriodo) && strUnidadTiempoPeriodo.Equals(strExcelUnidadTiempoPeriodo))
                                {
                                    if (validaSize(bufferDeudaPublica.Length, strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo))
                                    {
                                        dsNICSPDatos = WSINICSP_PC.InsertarArchivoEstadoFinancieroFileStream(bufferDeudaPublica, strIdEntidad, int.Parse(CodigoEstadosFinancieros_EstadoDeudaPublica),
                                                      int.Parse(strPeriodo), strUnidadTiempoPeriodo, Path.GetFileNameWithoutExtension(strNombreArchivo),
                                                      Path.GetExtension(strNombreArchivo), bufferDeudaPublica.Length, DateTime.Now, gstr_Usuario, "", gstr_Usuario, out Resultado, out Mensaje);
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                DTSX_CargaEstadosFinancierosDeudaPublica = ConfigurationManager.AppSettings["DTSX_CargaEstadosFinancierosDeudaPublica"].ToString();
                                                Run64BitRuntime_DTSX_CargaEstadosFinancierosDeudaPublica = bool.Parse(ConfigurationManager.AppSettings["Run64BitRuntime_DTSX_CargaEstadosFinancierosDeudaPublica"].ToString());

                                                //VarDTSX = "/SET \\Package.Variables[User::PathExcelFile].Properties[Value];\"L:\\SistemaGestor\\Archivos_SistemaGestor\\\\\" /SET \\Package.Variables[User::NameExcelFile].Properties[Value];\"" + NombreArchivo + TipoArchivo + "\" /SET \\Package.Variables[User::UsuarioCarga].Properties[Value];\"dmendez\"";
                                                VarDTSX = "/SET \\Package.Variables[User::PathExcelFile].Properties[Value];\"" + DTSX_RutaDescargaArchivo + "\" /SET \\Package.Variables[User::NameExcelFile].Properties[Value];\"" + NombreArchivo + TipoArchivo + "\" /SET \\Package.Variables[User::UsuarioCarga].Properties[Value];\"" + strUsuario + "\"";
                                                if (blnDTSX_EjecucionJob)
                                                {
                                                    str_res = WSINICSP_PC.uwsEjecutarDTSXBD(DTSX_RutaDescargaArchivo, DTSX_CargaEstadosFinancierosDeudaPublica, strNombreArchivo, !Run64BitRuntime_DTSX_CargaEstadosFinancierosDeudaPublica, DTSX_Ruta32Bit, "", gstr_Usuario, strJobFolder, strJobProjDeuda, out Resultado, out Mensaje);
                                                }
                                                else
                                                {
                                                    str_res = WSINICSP_PC.uwsEjecutarDTSX(DTSX_PaqueteURL, DTSX_CargaEstadosFinancierosDeudaPublica, VarDTSX, Run64BitRuntime_DTSX_CargaEstadosFinancierosDeudaPublica, DTSX_Ruta32Bit, "", gstr_Usuario, out Resultado, out Mensaje);
                                                }
                                                ///*dsNICSPDatos*/ string asd = WSINICSP_PC.uwsPrueba2("", ""/*,out Resultado, out Mensaje*/);
                                                //dsNICSPDatos = WSINICSP_PC.ValidarEstadoFinancieroDeudaPublica(strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo, "", gstr_usuario, out Resultado, out Mensaje);
                                                ...
                                                if (DesplegarError(!Resultado.Equals("00")))
                                                {
                                                    ...
                                                    if (DesplegarError(!Eliminar_EstadoFinanciero(CodigoEstadosFinancieros_EstadoDeudaPublica, strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo)))
                                                    {
                                                        txtError.Text = txtError.Text + "\r\n" + ConfigurationManager.AppSettings["strErrorBorrarArchivo"].ToString() + " " + CodigoEstadosFinancieros_EstadoDeudaPublica + " " + strIdEntidad + " " + strUnidadTiempoPeriodo + " " + strPeriodo;
                                                    }
                                                ...
                                                else
                                                {
                                                    ...
                                                    dsNICSPDatos = WSINICSP_PC.ValidarEstadoFinancieroDeudaPublica(strIdEntidad,
                                                        int.Parse(strPeriodo), strUnidadTiempoPeriodo, "", gstr_Usuario, out Resultado, out Mensaje);
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        if (!dsNICSPDatos.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                                                        {
                                                            string Consecutivo, ErrorDescripcion, IdEntidad, Periodo, UnidadTiempoPeriodo, NumConsecutivo, Obligaciones, ImputContRelac, SaldoCapitIniEjerInfo_SaldoCierPerioAnter, SaldoCapitIniEjerInfo_AjusSaldoIni, SaldoCapitIniEjerInfo_SaldoAjusPerioActu, MovEjer_Increm_MovPresupuest, MovEjer_Increm_MovSinImpacPresupuest, MovEjer_Increm_Total, MovEjer_Disminuc_MovPresupuest, MovEjer_Disminuc_MovSinImpacPresupuest, MovEjer_Disminuc_Total, InterVenci_Pagados, InterVenci_Impagos, GastComisEjer, SaldoCapitColonCierPerio;

                                                            txtError.Text = txtError.Text + "\r\n" + "Validación de los Datos de la Deuda Pública...";
                                                            txtError.Text = txtError.Text + "\r\n" + "Consecutivo, ErrorDescripcion, IdEntidad, Periodo, UnidadTiempoPeriodo, NumConsecutivo, Obligaciones, ImputContRelac, SaldoCapitIniEjerInfo_SaldoCierPerioAnter, SaldoCapitIniEjerInfo_AjusSaldoIni, SaldoCapitIniEjerInfo_SaldoAjusPerioActu, MovEjer_Increm_MovPresupuest, MovEjer_Increm_MovSinImpacPresupuest, MovEjer_Increm_Total, MovEjer_Disminuc_MovPresupuest, MovEjer_Disminuc_MovSinImpacPresupuest, MovEjer_Disminuc_Total, InterVenci_Pagados, InterVenci_Impagos, GastComisEjer, SaldoCapitColonCierPerio";
                                                            for (int i = 0; i <= dsNICSPDatos.Tables["Table"].Rows.Count - 1; i++)
                                                            {
                                                                Consecutivo = dsNICSPDatos.Tables["Table"].Rows[i]["Consecutivo"].ToString();
                                                                ErrorDescripcion = dsNICSPDatos.Tables["Table"].Rows[i]["ErrorDescripcion"].ToString();
                                                                ...
                                                                UnidadTiempoPeriodo = dsNICSPDatos.Tables["Table"].Rows[i]["UnidadTiempoPeriodo"].ToString();
                                                                NumConsecutivo = dsNICSPDatos.Tables["Table"].Rows[i]["NumConsecutivo"].ToString();
                                                                Obligaciones = dsNICSPDatos.Tables["Table"].Rows[i]["Obligaciones"].ToString();
                                                                ImputContRelac = dsNICSPDatos.Tables["Table"].Rows[i]["ImputContRelac"].ToString();
                                                                SaldoCapitIniEjerInfo_SaldoCierPerioAnter = dsNICSPDatos.Tables["Table"].Rows[i]["SaldoCapitIniEjerInfo_SaldoCierPerioAnter"].ToString();
                                                                SaldoCapitIniEjerInfo_AjusSaldoIni = dsNICSPDatos.Tables["Table"].Rows[i]["SaldoCapitIniEjerInfo_AjusSaldoIni"].ToString();
                                                                SaldoCapitIniEjerInfo_SaldoAjusPerioActu = dsNICSPDatos.Tables["Table"].Rows[i]["SaldoCapitIniEjerInfo_SaldoAjusPerioActu"].ToString();
                                                                MovEjer_Increm_MovPresupuest = dsNICSPDatos.Tables["Table"].Rows[i]["MovEjer_Increm_MovPresupuest"].ToString();
                                                                MovEjer_Increm_MovSinImpacPresupuest = dsNICSPDatos.Tables["Table"].Rows[i]["MovEjer_Increm_MovSinImpacPresupuest"].ToString();
                                                                MovEjer_Increm_Total = dsNICSPDatos.Tables["Table"].Rows[i]["MovEjer_Increm_Total"].ToString();
                                                                MovEjer_Disminuc_MovPresupuest = dsNICSPDatos.Tables["Table"].Rows[i]["MovEjer_Disminuc_MovPresupuest"].ToString();
                                                                MovEjer_Disminuc_MovSinImpacPresupuest = dsNICSPDatos.Tables["Table"].Rows[i]["MovEjer_Disminuc_MovSinImpacPresupuest"].ToString();
                                                                MovEjer_Disminuc_Total = dsNICSPDatos.Tables["Table"].Rows[i]["MovEjer_Disminuc_Total"].ToString();
                                                                InterVenci_Pagados = dsNICSPDatos.Tables["Table"].Rows[i]["InterVenci_Pagados"].ToString();
                                                                InterVenci_Impagos = dsNICSPDatos.Tables["Table"].Rows[i]["InterVenci_Impagos"].ToString();
                                                                GastComisEjer = dsNICSPDatos.Tables["Table"].Rows[i]["GastComisEjer"].ToString();
                                                                SaldoCapitColonCierPerio = dsNICSPDatos.Tables["Table"].Rows[i]["SaldoCapitColonCierPerio"].ToString();

                                                                txtError.Text = txtError.Text + "\r\n" + Consecutivo + ", " + ErrorDescripcion + ", " + IdEntidad + ", " + Periodo + ", " + UnidadTiempoPeriodo + ", " + NumConsecutivo + ", " + Obligaciones + ", " + ImputContRelac + ", " + SaldoCapitIniEjerInfo_SaldoCierPerioAnter + ", " + SaldoCapitIniEjerInfo_AjusSaldoIni + ", " + SaldoCapitIniEjerInfo_SaldoAjusPerioActu + ", " + MovEjer_Increm_MovSinImpacPresupuest + ", " + MovEjer_Increm_Total + ", " + MovEjer_Disminuc_MovPresupuest + ", " + MovEjer_Disminuc_MovSinImpacPresupuest + ", " + MovEjer_Disminuc_Total + ", " + InterVenci_Pagados + ", " + InterVenci_Impagos + ", " + GastComisEjer + ", " + SaldoCapitColonCierPerio;
                                                                DesplegarError(true);
                                                            }
                            ...
                            {
                                if (DeudaPublicaFileUpload.Enabled)
                                {
                                    DesplegarError(true);
                                    txtError.Text = txtError.Text + "\r\n" + ConfigurationManager.AppSettings["strErrorNoExisteArchivoDeudaPublica"].ToString();
                                }
                            }
        ...
        protected void CargarArchivosAnexosButton_Click(object sender, EventArgs e)
        {
            ...
            ArchivoAnexoFileUpload.FileContent.Read(bufferArchivoAnexo, 0, bufferArchivoAnexo.Length);
        ...
        public bool VisibleParametrosPrincipales(bool Enabled)
        {
            try
            {
                AmbitoConsolidacionLabel.Enabled = Enabled;
                AmbitoConsolidacionDropDownList.Enabled = Enabled;
                CatalogoEntidadesLabel.Enabled = Enabled;
                CatalogoEntidadesDropDownList.Enabled = Enabled;
                PeriodoLabel.Enabled = Enabled;
                PeriodoDropDownList.Enabled = Enabled;
                UnidadTiempoPeriodoLabel.Enabled = Enabled;
                UnidadTiempoPeriodoDropDownList.Enabled = Enabled;
                InfoCargadaEstadosFinancierosArchivosButton.Enabled = Enabled;
            ...
            try
            {
                ...
                if (ArchivosPlantillasFileUpload.FileContent.Length > 0)
                {
                    ...
                    if ((!strEstadoFinanciero.Equals(string.Empty)))
                    {
                        ...
                        {
                            Resultado = "99";
                            Mensaje = "Error en WS de cargar de archivo" + e1.ToString();
                        }
                        if (dsNICSPDatos.Tables.Count > 0 ) 
                        if (dsNICSPDatos.Tables["Table1"].Rows.Count > 0)//Si hizo la consulta pero No retorno nada
                        //if (!dsNICSPDatosDropDownList.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                        {
                            for (int i = 0; i <= dsNICSPDatos.Tables["Table1"].Rows.Count - 1; i++)
                            {
        ...
        protected void RevisionInstitucionButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    if (ValidarVisibilidadEstadosEtapas().Equals("0"))
                    {
                        bCambioEstado = WSINICSP_PC.InsertarEtapaEstadoFinanciero(strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo, int.Parse(CodigoCatalogoEtapasEstadoFinancieroUsuarioInstitucion),
                        NotaRazon, strUsuario, DateTime.Now, "", gstr_Usuario, out Resultado, out Mensaje);

                        if (DesplegarError(!bCambioEstado))
                        {
                            WSINICSP_PC.EliminarEtapaEstadoFinanciero(strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo, int.Parse(CodigoCatalogoEtapasEstadoFinancieroUsuarioInstitucion),
                            NotaRazon, strUsuario, DateTime.Now, "", gstr_Usuario, out Resultado, out Mensaje);
                            txtError.Text = txtError.Text + "\r\n" + ConfigurationManager.AppSettings["strErrorCambioEstado"].ToString() + ". Etapa:" + CodigoCatalogoEtapasEstadoFinancieroUsuarioInstitucion;
                        }
                    }
                    ...
                    if (!DesplegarError(!bCambioEstado))
                    {
                        ...
                        if (DesplegarError(!bCambioEstado))
                        {
                            ...
                            WSINICSP_PC.EliminarEtapaEstadoFinanciero(strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo, int.Parse(CodigoCatalogoEtapasEstadoFinancieroEnTramiteRevisionInstitucion),
                        NotaRazon, strUsuario, DateTime.Now, "", gstr_Usuario, out Resultado, out Mensaje);
                        ...
                        else
                        {
                            ...
                            string str_RolTo = ConfigurationManager.AppSettings["IdRolRevisionEntidad"].ToString();
                            string str_Asunto = ConfigurationManager.AppSettings["CorreoAsuntoRevisionInstitucion"].ToString();
                            string str_Mensaje = ConfigurationManager.AppSettings["CorreoRevision_Usuario_RevisionInstitucion"].ToString();
                            ...
                            //EnviarCorreo(str_CorreoFrom, "dmendezserrano@hotmail.com", str_Mensaje, str_Asunto);
                            //EnviarCorreo(str_CorreoFrom, str_CorreoTo, str_Mensaje, str_Asunto);

                            if (bErrorCorreo)
                            {   //cucurucho - se habilita el envío de correo 06/12/2018
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (bErrorCorreo)
                            {
                                ...
                                RechazadoInstitucionButton.Enabled = false;
                                AprobarInstitucionButton.Enabled = false;
                                RechazadoAnalistaButton.Enabled = true;
                                AprobarAnalistaButton.Enabled = true;                             
                            }
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            string str_IDUsuario = gstr_Usuario;
                            string str_RolTo = ConfigurationManager.AppSettings["IdRolCargaEntidad"].ToString();
                            string str_Asunto = ConfigurationManager.AppSettings["CorreoAsuntoRechazoContabilidad"].ToString();
                            string str_Mensaje = ConfigurationManager.AppSettings["CorreoRechazo_RevisionContabilidad_Usuario"].ToString();
                            string Anexo_UsuarioCorreo = ConfigurationManager.AppSettings["Anexo_UsuarioCorreo"].ToString();
                            bool bErrorCorreo = false;
        ...
        protected void AprobarAnalistaButton_Click(object sender, EventArgs e)
        {
            DataSet dsNICSPDatos = new DataSet();
            wsPlantillasConsolidacion WSINICSP_PC = new wsPlantillasConsolidacion();
            WSINICSP_PC.Timeout = 999999;
            wsBalanceComprobacion WSINICSP_BalanceComprobacion = new wsBalanceComprobacion();

            

            WSINICSP_BalanceComprobacion.Timeout = 999999;
            
            Presentacion.wsBC.ZINT_EST_CAB_BALANCE_CONSOL WSINICSP_BalanceComprobacion_Cabecera = new Presentacion.wsBC.ZINT_EST_CAB_BALANCE_CONSOL();
            //ZINT_EST_POS_BALANCE_CONSOL WSINICSP_BalanceComprobacion_Posicion = new ZINT_EST_POS_BALANCE_CONSOL();
            //ZINT_EST_POS_BALANCE_CONSOL[] WSINICSP_BalanceComprobacion_Posiciones = new ZINT_EST_POS_BALANCE_CONSOL[2];

            try
            {
                string strUsuario, strIdEntidad, strPeriodo, strUnidadTiempoPeriodo;
                string strBalanceRespuesta_ID, strBalanceRespuesta_MESSAGE, strBalanceRespuesta_NUMBER, strBalanceRespuesta_TYPE = "";
                ...
                if ((!strIdEntidad.Equals(string.Empty)) && (!strPeriodo.Equals("Seleccione ítem")) && (!strUnidadTiempoPeriodo.Equals(string.Empty)))
                {
                        ...
                        dsNICSPDatos = WSINICSP_PC.BuscarEstadoFinancieroBalanceComprobacionParaSIGAF(strIdEntidad, int.Parse(strPeriodo), strUnidadTiempoPeriodo,
                                                                                       "", gstr_Usuario, out Resultado, out Mensaje);

                        if (dsNICSPDatos.Tables.Count > 0 && dsNICSPDatos.Tables["Table"].Rows.Count > 0)//Si hizo la consulta pero No retorno nada
                        //if (!dsNICSPDatosDropDownList.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                        {
                            Presentacion.wsBC.ZINT_EST_POS_BALANCE_CONSOL[] WSINICSP_BalanceComprobacion_Posiciones = new Presentacion.wsBC.ZINT_EST_POS_BALANCE_CONSOL[dsNICSPDatos.Tables["Table"].Rows.Count];
                            //ZINT_EST_POS_BALANCE_CONSOL[] WSINICSP_BalanceComprobacion_Posiciones = new ZINT_EST_POS_BALANCE_CONSOL[501];

                            //Ledger				VARCHAR(2),
                            WSINICSP_BalanceComprobacion_Cabecera.LEDGER = dsNICSPDatos.Tables["Table"].Rows[0]["Ledger"].ToString();
                            //Vista					VARCHAR(2),
                            WSINICSP_BalanceComprobacion_Cabecera.VISTA = dsNICSPDatos.Tables["Table"].Rows[0]["Vista"].ToString();
                            //[Version]				INT,
                            WSINICSP_BalanceComprobacion_Cabecera.VERSION = dsNICSPDatos.Tables["Table"].Rows[0]["Version"].ToString();
                            //Ejercicio				INT,
                            WSINICSP_BalanceComprobacion_Cabecera.EJERCICIO = dsNICSPDatos.Tables["Table"].Rows[0]["Ejercicio"].ToString();
                            //Periodo				INT,
                            WSINICSP_BalanceComprobacion_Cabecera.PERIODO = dsNICSPDatos.Tables["Table"].Rows[0]["Periodo"].ToString();
                            //SociedadGL			VARCHAR(18),
                            WSINICSP_BalanceComprobacion_Cabecera.UNID_CONSOL = dsNICSPDatos.Tables["Table"].Rows[0]["SociedadGL"].ToString();
                            //PlanDePosiciones		VARCHAR(2),
                            WSINICSP_BalanceComprobacion_Cabecera.PLAN_POS = dsNICSPDatos.Tables["Table"].Rows[0]["PlanDePosiciones"].ToString();


                            for (int i = 0; i <= dsNICSPDatos.Tables["Table"].Rows.Count - 1; i++)
                            {
                                Presentacion.wsBC.ZINT_EST_POS_BALANCE_CONSOL WSINICSP_BalanceComprobacion_Posicion = new Presentacion.wsBC.ZINT_EST_POS_BALANCE_CONSOL();

                                    //PosicionConsolidacion	VARCHAR(10),
                                    WSINICSP_BalanceComprobacion_Posicion.POSICION = dsNICSPDatos.Tables["Table"].Rows[i]["PosicionConsolidacion"].ToString();
                                    //AreaFuncional			VARCHAR(10),
                                    WSINICSP_BalanceComprobacion_Posicion.SUBPOSICION = dsNICSPDatos.Tables["Table"].Rows[i]["AreaFuncional"].ToString();
                                    //UnidadAsociada		VARCHAR(18),
                                    WSINICSP_BalanceComprobacion_Posicion.UNID_ASOCIADA = dsNICSPDatos.Tables["Table"].Rows[i]["UnidadAsociada"].ToString();
                                    //Moneda				VARCHAR(3),
                                    WSINICSP_BalanceComprobacion_Posicion.MONEDA = dsNICSPDatos.Tables["Table"].Rows[i]["Moneda"].ToString();
                                    //Signo					VARCHAR(1),
                                    WSINICSP_BalanceComprobacion_Posicion.SIGNO = dsNICSPDatos.Tables["Table"].Rows[i]["Signo"].ToString();
                                    //ImporteML				DECIMAL(17,2),
                                    WSINICSP_BalanceComprobacion_Posicion.VALOR_ML = decimal.Parse(dsNICSPDatos.Tables["Table"].Rows[i]["ImporteML"].ToString());
                                    //ImporteMT				DECIMAL(17,2),
                                    WSINICSP_BalanceComprobacion_Posicion.VALOR_MT = decimal.Parse(dsNICSPDatos.Tables["Table"].Rows[i]["ImporteMT"].ToString());
                                    //ImporteColones		DECIMAL(17,2)
                                    WSINICSP_BalanceComprobacion_Posicion.VALOR_AC = decimal.Parse(dsNICSPDatos.Tables["Table"].Rows[i]["ImporteColones"].ToString());

                                    WSINICSP_BalanceComprobacion_Posiciones[i] = WSINICSP_BalanceComprobacion_Posicion;

                                    WSINICSP_BalanceComprobacion_Posicion = null;
                            ...
                            {
                                string x = "";
                                dsNICSPDatos = WSINICSP_BalanceComprobacion.uwsBalanceComprobacion(WSINICSP_BalanceComprobacion_Cabecera, WSINICSP_BalanceComprobacion_Posiciones);
                                
                                //dsNICSPDatos = WSINICSP_PC.uwsBalanceComprobacion(WSINICSP_BalanceComprobacion_Cabecera, WSINICSP_BalanceComprobacion_Posiciones, out Resultado, out Mensaje);
                                
                            }
                            catch(Exception e1)
                            {
                                strBalanceRespuesta_TYPE = "N";
                                DesplegarError(true);
                                txtError.Text = txtError.Text + "\r\n" + "Mensaje: " + e1.ToString()+ " "+Mensaje;
                            }
                            /*if (Resultado!="00")
                            {
                            ...
                            //if (!dsNICSPDatosDropDownList.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                            {
                                for (int i = 0; i <= dsNICSPDatos.Tables["Table"].Rows.Count - 1; i++)
                                {                                    
                                    strBalanceRespuesta_ID = dsNICSPDatos.Tables["Table"].Rows[i]["ID"].ToString();
                                    strBalanceRespuesta_MESSAGE = dsNICSPDatos.Tables["Table"].Rows[i]["MESSAGE"].ToString();
                                    strBalanceRespuesta_NUMBER = dsNICSPDatos.Tables["Table"].Rows[i]["NUMBER"].ToString();
                                    strBalanceRespuesta_TYPE = dsNICSPDatos.Tables["Table"].Rows[i]["TYPE"].ToString();

                                    txtError.Text = txtError.Text + "\r\n" + "ID: " + strBalanceRespuesta_ID + ", " + "Mensaje: " + strBalanceRespuesta_MESSAGE + ", " + "Número: " + strBalanceRespuesta_NUMBER + ", " + "Tipo: " + strBalanceRespuesta_TYPE;
                                }
                                if (!strBalanceRespuesta_TYPE.Equals("S"))
                                    DesplegarError(true);
                            }
                            ...
                            if (strBalanceRespuesta_TYPE.Equals("S"))
                            {
                                ...
                                else
                                {
                                    ...
                                    /*Inicio mandar correo*/

                                    //Envia correo
                                    string str_CorreoFrom = "", str_CorreoTo = "", str_NombreUsuario = "";
                                    string str_IDUsuario = gstr_Usuario;
                                    //string str_RolTo = ConfigurationManager.AppSettings["IdRolCargaEntidad"].ToString();
                                    //cambio Gaston, el 16/06/2020, por incidente de don Miguel CUCURUCHO
                                    string str_RolTo = ConfigurationManager.AppSettings["IdRolRevisionAnalista"].ToString();

                                    string str_Asunto = ConfigurationManager.AppSettings["CorreoAsuntoAprobacionContabilidad"].ToString();
                                    string str_Mensaje = ConfigurationManager.AppSettings["CorreoAprobado_RevisionContabilidad_Usuario"].ToString();
                                    string Anexo_UsuarioCorreo = ConfigurationManager.AppSettings["Anexo_UsuarioCorreo"].ToString();
                                    bool bErrorCorreo = false;
                    ...
                    if (Resultado.Equals("00"))
                    {
                        if (dsNICSPDatos.Tables.Count > 0 && dsNICSPDatos.Tables["Table"].Rows.Count > 0)//Si hizo la consulta pero No retorno nada                    
                        {
                            if (!dsNICSPDatos.Tables["Table"].Rows.Count.Equals(0))//Si hizo la consulta pero No retorno nada
                            {
                                ...
                                if (IdEtapaEstadoFinanciero.Equals("1"))//UsuarioInstitucion
                                {
                                    RevisionInstitucionButton.Enabled = true;
                                    RechazadoInstitucionButton.Enabled = false;
                                    AprobarInstitucionButton.Enabled = false;
                                ...
                                else
                                {
                                    ...
                                    {
                                        if (IdEtapaEstadoFinanciero.Equals("5"))//EnTramiteRevisionAnalista
                                        {
                                            RevisionInstitucionButton.Enabled = false;
                                            RechazadoInstitucionButton.Enabled = false;
                                            AprobarInstitucionButton.Enabled = false;
