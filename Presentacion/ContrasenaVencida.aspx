<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/PortalSistemaGestor.Master" AutoEventWireup="true" CodeBehind="ContrasenaVencida.aspx.cs" Inherits="Presentacion.ContrasenaVencida" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <table class="asd">
        ...
        <tr>
            ...
            <td>
                <asp:RegularExpressionValidator Display="Dynamic" ForeColor="Red" ControlToValidate="txtNuevaContrasena" ValidationExpression="^[\s\S]{8,}$" runat="server" ErrorMessage="La contraseña debe tener mínimo 8 caracteres."></asp:RegularExpressionValidator></td>
        </tr>
        <tr>
            <td class="auto-style2">
