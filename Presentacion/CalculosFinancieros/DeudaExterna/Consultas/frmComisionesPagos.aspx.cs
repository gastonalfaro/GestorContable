...
{
    public partial class frmComisionesPagos : BASE
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        if (!clsSeguridadVistas.MostrarElementos(gstr_Usuario, Master, "frmComisionesPagosDE"))
                        {
        ...
        private void ConsultarFormularios(string str_IdPrestamo, string str_IdTramo, string str_FechaPago, string str_Secuencia, string str_Consecutivo)
        {

            gds_Formularios = wsDE.ConsultarComisionPago(str_IdPrestamo, str_IdTramo, str_FechaPago, str_Secuencia, str_Consecutivo);
        ...
        {
            OcultarMensaje();
            ConsultarFormularios(txtBusqIdPrestamo.Text, txtBusqIdTramo.Text, txtFechaPago.Text, txtSecuencia.Text, txtConsecutivo.Text);
        }
        ...
        protected void grdvFormularios_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            grdvFormularios.DataBind();
            //this.ConsultarFormularios(txtBusqIdPrestamo.Text, txtBusqIdTramo.Text, txtFechaPago.Text, txtSecuencia.Text, txtConsecutivo.Text);
        }
