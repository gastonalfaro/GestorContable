...
{
    public partial class frmTasasFlotantes : BASE
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        if (!clsSeguridadVistas.MostrarElementos(gstr_Usuario, Master, "frmTasasFlotantesDE"))
                        {
        ...
        private void ConsultarFormularios(string str_IdPrestamo, string str_IdTramo, string dt_FchAPartir)
        {

            gds_Formularios = wsDE.ConsultarTasaFlotante(str_IdPrestamo,str_IdTramo, dt_FchAPartir);
        ...
        private DataTable LlenarTablaVacia()
        {
            ...
            ldt_TablaVacia.Columns.Add("APartir", typeof(string));
        ...
        {
            OcultarMensaje();
            ConsultarFormularios(txtBusqIdPrestamo.Text,txtBusqIdTramo.Text , txtAPartir.Text);
        ...
        protected void grdvFormularios_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            grdvFormularios.DataBind();
            //this.ConsultarFormularios(txtBusqIdPrestamo.Text, txtBusqIdTramo.Text, txtAPartir.Text);
        }
    }
}