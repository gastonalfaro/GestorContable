...
{
    public partial class frmInteresePunitivosPagos : BASE
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        if (!clsSeguridadVistas.MostrarElementos(gstr_Usuario, Master, "frmInteresePunitivosPagosDE"))
                        {
        ...
        private void ConsultarFormularios(string str_IdPrestamo, string str_IdTramo, string dt_FchAPartir, string str_Secuencia)
        {

            gds_Formularios = wsDE.ConsultarInteresPunitivoPago(str_IdPrestamo, str_IdTramo, dt_FchAPartir, str_Secuencia);
        ...
        private DataTable LlenarTablaVacia()
        {
            ...
            ldt_TablaVacia.Columns.Add("FchAPartir", typeof(string));
        ...
        {
            OcultarMensaje();
            ConsultarFormularios(txtBusqIdPrestamo.Text, txtBusqIdTramo.Text, txtBusqFchAPartir.Text,"");
        }
        ...
        protected void grdvFormularios_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            grdvFormularios.DataBind();
            //this.ConsultarFormularios(txtBusqIdPrestamo.Text, txtBusqIdTramo.Text, txtBusqFchAPartir.Text, "");
        }
