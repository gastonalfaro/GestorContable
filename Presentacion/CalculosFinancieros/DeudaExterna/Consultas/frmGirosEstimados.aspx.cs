...
{
    public partial class frmGirosEstimados : BASE
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        if (!clsSeguridadVistas.MostrarElementos(gstr_Usuario, Master, "frmGirosEstimadosDE"))
                        {
        ...
        private void ConsultarFormularios(string str_IdPrestamo, string str_IdTramo, string dt_Fecha)
        {

            gds_Formularios = wsDE.ConsultarGiroEstimado(str_IdPrestamo, str_IdTramo, dt_Fecha);
        ...
        {
            OcultarMensaje();
            ConsultarFormularios(txtBusqIdPrestamo.Text, txtBusqIdTramo.Text, txtFecha.Text);
        ...
        protected void grdvFormularios_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            grdvFormularios.DataBind();
            //this.ConsultarFormularios(txtBusqIdPrestamo.Text, txtBusqIdTramo.Text, txtFecha.Text);
        }
