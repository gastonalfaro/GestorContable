...
{
    public partial class frmTramos : BASE
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        if (!clsSeguridadVistas.MostrarElementos(gstr_Usuario, Master, "frmTramosDE"))
                        {
        ...
        private void ConsultarFormularios(string str_IdTramo, string str_IdPrestamo, string ddl_TipoAcuerdo, string ddl_TipoFinanciamiento)
        {

            gds_Formularios = wsDE.ConsultarTramo(str_IdPrestamo, str_IdTramo, ddl_TipoAcuerdo, ddl_TipoFinanciamiento, "", "", "", "", "");
        ...
        private DataTable LlenarTablaVacia()
        {
            ...
            ldt_TablaVacia.Columns.Add("TipoAcuerdo", typeof(string));
            ldt_TablaVacia.Columns.Add("TipoFinanciamiento", typeof(string));
            ldt_TablaVacia.Columns.Add("TipoInstrumento", typeof(string));
            ldt_TablaVacia.Columns.Add("TerminoCredito", typeof(string));
            ldt_TablaVacia.Columns.Add("Reorganizacion", typeof(string));
            ldt_TablaVacia.Columns.Add("TerminoReorganizado", typeof(string));
            ldt_TablaVacia.Columns.Add("Monto", typeof(string));
            ldt_TablaVacia.Columns.Add("IdMoneda", typeof(string));  //typeof(string));
        ...
        {
            OcultarMensaje();
            ConsultarFormularios(txtBusqIdTramo.Text, txtBusqIdPrestamo.Text, ddlTipoAcuerdo.Text, ddlTipoFinanciamiento.Text);
        }
        ...
        protected void grdvFormularios_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            grdvFormularios.DataBind();
            //this.ConsultarFormularios(txtBusqIdTramo.Text, txtBusqIdPrestamo.Text, ddlTipoAcuerdo.Text, ddlTipoFinanciamiento.Text);
        }
