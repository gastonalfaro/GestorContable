...
{
    public partial class frmReporteDevengoDE : BASE
    {
        # region Variables
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        CargarDDLs();
                        if (!clsSeguridadVistas.MostrarElementos(gstr_Usuario, Master, "frmReporteDevengoDE"))
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string lstr_IdPrestamo, lstr_IdTramo, lstr_FechaFin;
                ...
                lstr_IdTramo = ddlNroTramo.SelectedValue;
                ...
                if (!strUsuario.Equals(string.Empty))// && (!str_Institucion.Equals(string.Empty)))
                {
                    ...
                    oParametros.Add(new ReportParameter("pFechaHasta", lstr_FechaFin, false));

                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteDevengoDE"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
