...
{
    public partial class frmReporteOperacionesEspeciales : BASE
    {
        # region Variables
      ...
      //private static DataTable ldat_Cancelaciones = new DataTable();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        if (!clsSeguridadVistas.MostrarElementos(gstr_Usuario, Master, "frmReporteOperacionesEspeciales"))
        ...
        protected String get_descripcion()
        {
            if (this.ddlSistemaNegociacion.SelectedItem.ToString().Equals("-- Seleccione Opcion --"))
            {
                return "";
            }
            else
            {
                return this.ddlSistemaNegociacion.SelectedItem.ToString();
            }
        }//FUNCION
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string lstr_Nemotecnico, lstr_NroValor, lstr_Tipo, lstr_TipoNegociacion, lstr_SistemaNegociacion;
                ...
                lstr_SistemaNegociacion = ddlSistemaNegociacion.SelectedValue;
                //RAMSES
                ...
                if (!strUsuario.Equals(string.Empty))// && (!str_Institucion.Equals(string.Empty)))
                {
                    ...
                    oParametros.Add(new ReportParameter("pSistemaNegociacion", lstr_SistemaNegociacion, false));
                    ...
                    //RAMSES
                    //if (ddlSistemaNegociacion.SelectedItem.ToString().Equals("-- Seleccione Opción --"))
                    //{
                    //    oParametros.Add(new ReportParameter("pDescripcion", descripcion, false));
                    //}
                    //else
                    //{
                    //    oParametros.Add(new ReportParameter("pDescripcion", String.Empty, false));
                    //}
                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteOperacionesEspeciales"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
        ...
        protected void ddlNemotecnico_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ddlNumValor.Items.Insert(0, (new ListItem("-- Seleccione Opción --", "0")));
        }
