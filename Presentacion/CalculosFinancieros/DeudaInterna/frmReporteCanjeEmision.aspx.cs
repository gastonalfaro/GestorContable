...
{
    public partial class frmReporteCanjeEmision : BASE
    {
        # region Variables
       ...
       //private static DataTable ldat_Cancelaciones = new DataTable();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        if (!clsSeguridadVistas.MostrarElementos(gstr_Usuario, Master, "frmReporteCanjeEmision"))
        ...
        private void CargarNumeroSerie()
        {
            ...
            this.ddlNumSerie.DataSource = ws_SGService.uwsConsultarDinamico("SELECT DISTINCT([NroEmisionSerie]) FROM [cf].[TitulosValores] WHERE [IndicadorCupon] = 'V' AND [TipoNegociacion] = 'Compra' and DescripcionNegociacion in ('Canje/Lici/Precio','Canje/Lici/Rend','Canje/Inversa/Precio','Canje/Inversa/Rend') ");
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string lstr_NroEmisionSerie,lstr_FchCanje;
                ...
                if (!strUsuario.Equals(string.Empty))// && (!str_Institucion.Equals(string.Empty)))
                {
                    ...
                    ParametrosReporte oParam = new ParametrosReporte(ConfigurationManager.AppSettings["ReporteCanjeEmision"], oParametros, ConfigurationManager.AppSettings["ServidorReportes"]);
