<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/PortalPrincipal.Master" AutoEventWireup="true" CodeBehind="frmPagosCCSS.aspx.cs" Inherits="Presentacion.CalculosFinancieros.DeudaInterna.frmPagosCCSS" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="Contenido" runat="server">
    <div>
        <h3>Cargar información: Pagos de deudas CCSS</h3>
        <table style="width: 100%;">
            <tr>
                <td colspan="3">
                    ...
                    <br />
                    <b>Nota Importante:</b> Al descargar el archivo, reemplace (en el nombre del archivo) la palabra plantilla, por su número de cédula. Incluya ceros sin espacios. Ej: CCSS_0109990888&quot;</td>
            </tr>
            <tr>
                <td>
                    <br />
