<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/PortalPrincipal.Master" AutoEventWireup="true" CodeBehind="frmReporteValora.aspx.cs" Inherits="Presentacion.CalculosFinancieros.DeudaInterna.frmReporteValora" EnableEventValidation="false" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="Contenido" runat="server">
    <div id="datos">
        <div style="display: inline-block;">
            ...
            <h3>Reporte de Valoración de Moneda:</h3>
            ...
            <div class="col-md-12" style="margin-top: 2%;">
                ...
                <div class="col-md-6" style="margin-top: 1%;">
                    ...
                    <div class="col-md-6">
                        <asp:DropDownList ID="ddlPlazo" runat="server" AppendDataBoundItems="True" AutoPostBack="True" CssClass="FormatoDropDownList">
                ...
                <div class="col-md-6" style="margin-top: 1%;">
                    ...
                    <div class="col-md-6">
                        <asp:DropDownList ID="ddlPropietario" runat="server" AppendDataBoundItems="True" AutoPostBack="True" CssClass="FormatoDropDownList">
                            <asp:ListItem Value="">-- Seleccione Opcion --</asp:ListItem>
                ...
                <div class="col-md-6" style="margin-top: 1%;">
                    <div class="col-md-4">Cuenta Afectada:</div>
                    <div class="col-md-6">
                        <asp:TextBox ID="txtCuenta" runat="server" CssClass="FormatoTextBox"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6" style="margin-top: 1%;">
