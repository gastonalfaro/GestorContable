    ...
    public partial class EdicionUsuario : BASE
    {
        ...
        private void ConsultarUsuario (string str_IdUsuario)
        {
            ...
            if (ldt_Usuario.Rows.Count > 0)
            {
                ...
                ddlInstitucion.SelectedValue = (ldt_Usuario.Rows[0]["IdSociedadGL"].ToString().Trim().Equals("0") || ldt_Usuario.Rows[0]["IdSociedadGL"].ToString().Trim().Equals("")) ? "0" : ldt_Usuario.Rows[0]["IdSociedadGL"].ToString().Trim(); 
